...
function spaceFromBottom(e) {
  return $(e).offset().top - $(window).scrollTop() < $(window).height() + 600;
}
function getFileName(e, t) {
  ($text = e.value),
    (document.getElementById(t).innerHTML = $text.split('\\')[2]);
}
...
function urlParser(e) {
  var t = document.createElement('a');
  return (t.href = e), t.hostname;
}
function getReferrer() {
  var e = document.referrer;
  if (getCookie('referrerURL')) var t = getCookie('referrerURL');
  if (e.length > 0 || t) {
    if (null != t)
      var n = urlParser(t),
        i = t.split('?')[1];
    else (n = urlParser(e)), (i = e.split('?')[1]);
    var s = !1,
      o = n;
    if (null != i) {
      for (var r = i.split('&'), a = [], l = 0; l < r.length; l++)
        a.push(r[l].split('='));
      for (l = 0; l < a.length; l++)
        for (var d = a[l], u = 0; u < d.length; u++)
          if (null !== d[u].match('gclid')) {
            s = !0;
            break;
          }
    }
    n !== window.location.hostname &&
      (t || setCookie('referrerURL', e, '7'),
      !0 === s
...
function parseParams(e) {
  ...
  for (const e of t.keys())
    t.getAll(e).length > 1 ? (n[e] = t.getAll(e)) : (n[e] = t.get(e));
  return n;
}
function itemsDown(e) {
  var t = $('.' + e),
    n = t.parent(),
    i = 0,
    s = n.height();
  n.children().each(function () {
    $(this).hasClass(e) ||
      ((i += $(this).outerHeight(!0)), console.log($(this)));
  });
  var o = s - i - t.height() - 50;
  o > 0 && t.css({ 'margin-top': o + 'px' });
}
/*! jQuery Validation Plugin - v1.19.5 - 7/1/2022
 * https://jqueryvalidation.org/
 * Copyright (c) 2022 Jörn Zaefferer; Licensed MIT */ function jobsAjaxFiltering() {
  $('.filters.job')
    .find('input')
    .on('click', function () {
      var e = $(this).data('key'),
        t = $(this).val(),
        n = { action: 'jobs_ajax_filtering', url: window.location.href };
      if (
        ...
        $(this).closest('.filter-input-li').hasClass('active'))
      ) {
        var i = n['"' + e + '"'].indexOf(t);
        i > -1 && n['"' + e + '"'].splice(i, 1),
          $(this)
      ...
      } else $(this).closest('.filter-input-li').addClass('active'), Array.isArray(n['"' + e + '"']) ? n['"' + e + '"'].push(t) : (n['"' + e + '"'] = [t]);
      var s = {};
      for (var [o, r] of Object.entries(n))
        'action' !== o && 'url' !== o && (s[o] = r);
      var a = n.url,
        l = $.param(s),
        d = new URL(a);
      d.search = l;
      var u = l.toString().replace(/"/g, '').replace(/%22/g, ''),
        c = d.toString().replace(/"/g, '').replace(/%22/g, '');
      window.history.replaceState({}, '', c);
      var h = parseParams(window.location.search);
      return (
        console.log(h),
        (n.params = u),
        console.log(n),
...
function postsAjaxFiltering() {
  $('.filters.post')
    ...
    .on('click', function () {
      var e = $(this).data('key'),
        t = $(this).data('value'),
        n = { action: 'post_ajax_filtering', url: window.location.href };
      if (
        ($('.job-category-filters')
          .find('*[data-key]')
          .each(function () {
        ...
        $(this).parent().parent('li').hasClass('active'))
      ) {
        var i = n['"' + e + '"'].indexOf(t);
        i > -1 && n['"' + e + '"'].splice(i, 1),
          $(this).parent().parent('li').removeClass('active');
      } else $(this).parent().parent('li').addClass('active'), Array.isArray(n['"' + e + '"']) ? n['"' + e + '"'].push(t) : (n['"' + e + '"'] = [t]);
      var s = {};
      for (var [o, r] of Object.entries(n))
        'action' !== o && 'url' !== o && (s[o] = r);
      var a = n.url,
        ...
        d = new URL(a);
      d.search = l;
      var u = d.toString().replace(/"/g, '').replace(/%22/g, '');
...
function quickFilters() {
  $('.header__jobs-cats')
    ...
    .on('click', function (e) {
      e.preventDefault();
      var t = $('#main-jobs-filter-form');
      switch ($(this).attr('href')) {
        case '#it':
          var n = $('.jobs__list-filters')
              .find('.job-category-filters')
              .find('li')
              .find('input[data-name="it"]'),
            i = $('.jobs__list-filters')
              .find('.job-category-filters')
              .find('li')
              .find('input[data-name="it"]')
              .parent()
        ...
        case '#executive':
          (n = $('.jobs__list-filters')
            ...
            (7e4 != n.val() ? n.val(7e4) : n.val(0), t.submit());
          break;
        case '#freelance':
          (n = $('.jobs__list-filters')
            ...
            )) && (n.prop('checked', !n.prop('checked')), t.submit());
      }
    }),
    $('.jobs__list-filters')
      .find('li.active')
      .each(function () {
        $(this).find('input[data-name="it"]').is(':checked') &&
          $('.header__jobs-cats').find('a[href="#it"]').addClass('active'),
          $(this).find('input[data-name="sales"]').is(':checked') &&
            $('.header__jobs-cats').find('a[href="#sales"]').addClass('active'),
          $(this).find('input[data-name="freelance"]').is(':checked') &&
            $('.header__jobs-cats')
              .find('a[href="#freelance"]')
              .addClass('active');
      }),
    8e4 ==
      $('.jobs__list-filters')
...
function megaMenu() {
  $(document).on('click', function (e) {
    var t = $(e.target);
    ((t.parents('.mega-menu-parent').length < 1 &&
      $('.mega-menu-parent').is(':visible')) ||
      t.hasClass('mega-menu-go-back')) &&
      (console.log(t),
      $('.mega-menu-parent')
        ...
        setTimeout(function () {
          $('.mega-menu__side-submenu-parent')
            ...
            $('.mega-menu__side-submenu')
              .not(e.parent().find('.mega-menu__side-submenu'))
              .stop(!0, !0)
              .css({ display: 'none' }),
            e
              .addClass('active')
        ...
        setTimeout(function () {
          $('.mega-menu__big-submenu')
            ...
            e
              ...
              .css({
                'min-height':
                  e.parent().find('.mega-menu__side-submenu').height() +
                  50 +
                  'px',
              });
        }, 200);
  ...
  $('.owl-carousel').each(function () {
    if ($(this).hasClass('articles-slider-cards'))
      ...
      t.owlCarousel({
        ...
        t.find('input[name="cta_dog_contact_email"]').on('keyup', function () {
        ...
        t.find('.next').click(function () {
          t.find('.owl-item.active').find('.pristine').hasClass('required')
            ? t.find('.owl-item.active').find('.valid').length > 0
              ? t.trigger('next.owl.carousel')
              : (t.find('.owl-item.active').find('.not-valid').focus(),
                t.find('.owl-item.active').find('.pristine').focus(),
                $(this)
                  .parent()
                  .find('span.d-none')
                  .removeClass('d-none')
...
function afterFormOpen() {
  if (0 == isScriptLoaded('https://apis.google.com/js/platform.js')) {
    var e = document.createElement('meta');
    (e.name = 'google-signin-client_id'),
      (e.content =
  ...
  0 == isScriptLoaded('https://connect.facebook.net/en_US/sdk.js') &&
...
function myLinkedinLogin(e, t, n = !1) {
  setCookie('redirect_user_url', t, 1),
    setCookie('api_type', 'linkedin', 1),
    n && setCookie('uploadcvmodal', !0, 1),
    (window.location.href =
      'https://www.linkedin.com/oauth/v2/authorization?response_type=code&client_id=77dug7ogaz4ouh&redirect_uri=' +
      e +
      '&scope=r_liteprofile%20r_emailaddress%20w_member_social');
}
function myGithubLogin(e, t = !1) {
  setCookie('redirect_user_url', e, 1),
    setCookie('api_type', 'github', 1),
    t && setCookie('uploadcvmodal', !0, 1),
    (window.location.href =
...
function SUMEDIAvideoCarousel() {
  ...
  var e = $('.video-cards');
  e.owlCarousel();
  const t = document.querySelectorAll('.video-placeholder, .play-video'),
    n = document.querySelectorAll('.video');
  e.on('changed.owl.carousel', function (e) {
    for (let e = 0; e < t.length; e += 1)
      t[e].parentElement.classList.remove('active');
    for (let e = 0; e < n.length; e += 1) n[e].load();
  });
}
...
function SUMEDIAswitchDNA() {
  const e = document.querySelector('.switch-dna');
  e &&
    e.addEventListener('click', () => {
      var t =
        ...
        n = e.querySelectorAll('.switch-dna--item');
      t[0].classList.contains('active')
        ? (t[0].classList.remove('active'),
          ...
          (e.id = t[1].id))
        : t[1].classList.contains('active')
        ? (t[1].classList.remove('active'),
          t[2].classList.add('active'),
          n[1].classList.remove('active'),
          n[2].classList.add('active'),
          (e.id = t[2].id))
        : t[2].classList.contains('active') &&
          (t[2].classList.remove('active'),
          t[0].classList.add('active'),
          n[2].classList.remove('active'),
          n[0].classList.add('active'),
          (e.id = t[0].id));
    });
}
function SUMEDIAplayVideo() {
  const e = document.querySelectorAll('.play-video'),
    t = document.querySelectorAll('.video'),
    n = document.querySelector('video'),
    i = document.querySelector('.videos .mfp-close');
  if (
    (null != i &&
      (i.onclick = () => {
        n.pause();
    ...
    for (let n = 0; n < e.length; n += 1)
      e[n].addEventListener('click', () => {
        if ((e[n].parentElement.classList.add('active'), t.length > 0))
          for (let e = 0; e < t.length; e += 1)
            t[e].parentElement.classList.contains('active') && t[e].play();
      });
}
function uglyInput() {
  $('.ugly').each(function () {
    ...
    e.on('change focusout', function () {
      !0 == !e.val()
        ? e.parent().find('.ugly-label').css({ opacity: 1 })
        : e.parent().find('.ugly-label').css({ opacity: 0 });
    });
  });
}
...
function bodyGradient() {
  ...
  if ($('.flex_content-tags').length > 0)
    var t =
      ...
      e;
  else $('.body-bg-gradient').height(), (t = 50);
  var n = '(180deg, #94D4E9 0%, #C0E5F2 ' + t + '%, #94D4E9 100%)',
    i = 'linear-gradient' + n,
    s = '-moz-linear-gradient' + n,
    o = '-webkit-linear-gradient' + n;
  $('.body-bg-gradient').css({ background: o, background: s, background: i });
}
function slideThem() {
  var e = $('*[href*="#"]');
  e &&
...
function bottomBar() {
  $('.bottom-bar').each(function () {
    ...
    !$(this).hasClass('show') &&
      $(window).scrollTop() > e &&
      ($(this).addClass('show'),
      $('#wrapper').css({ 'padding-bottom': e + 'px' }));
  });
}
    ...
    ($('.header__video')
      ...
      .on('click', function () {
        var e = $(this).find('video').get(0),
          t = $(this).find('.play-button');
        e.paused
          ? (e.play(), t.removeClass('d-block').addClass('d-none'))
          : (e.pause(), t.removeClass('d-none').addClass('d-block'));
      }),
    $('.header__video')
      .find('video')
      .on('click', function () {
        var e = $(this).get(0),
          t = $(this).next('.play-button');
        e.paused
          ? (e.play(), t.removeClass('d-block').addClass('d-none'))
          : (e.pause(), t.removeClass('d-none').addClass('d-block'));
      }));
...
function jobsLangLink() {
  if ($('#thePostSlugForJobLink') && $('#thePostSlugForJobLink').data('url')) {
    var e = $('#thePostSlugForJobLink').data('url'),
      t = $('ul.lang'),
      n = t.find('li.lang-item').find('a[lang="en-GB"]'),
      i = t.find('li.lang-item').find('a[lang="nl-NL"]');
    n.each(function () {
      $(this).attr('href', '/en/job/' + e);
    }),
      i.each(function () {
        $(this).attr('href', '/nl/vacature/' + e);
      });
  }
}
  ...
  $(document).on(
    ...
    function () {
      $(this)
        ...
        .attr('disabled', !0)
        .addClass('disabled'),
        'job-application-form' === $(this).attr('id')
          ? setCookie(
              'jobid_' + $(this).find('input.app-jobid').val(),
              $(this).find('input.app-jobid').val(),
              365
            )
          : 'cv-upload-form' === $(this).attr('id') &&
            setCookie('cvform', 'sent', 365);
    }
  );
}
function onFormLoad() {
  var e = $('#job-application-form').find('input.app-jobid').val(),
    t = getCookie('jobid_' + e);
  getCookie('cvform') && $('#cv-upload-form').addClass('cv-sent'),
    188 !== e &&
      e == t &&
...
function appValidation() {
  if ($('#job-application-form').length > 0) {
    ...
    e.validate({
      ...
      e.find('input.required').on('change focusout', function () {
        e.valid()
      ...
      e.find('.fake_btn_app').on('click', function (t) {
        t.preventDefault(),
          e.valid() &&
            ($('.fake_btn_app').addClass('d-none'),
            $('.g-recaptcha.app').removeClass('d-none'),
  ...
  $('#cv-upload-form').length > 0 &&
    $('#uploadCVModal').on('show.bs.modal', function (e) {
      var t = $('#cv-upload-form');
      t.validate({
        onfocusout: function (e) {
          $(e).valid();
        },
        ...
        t.find('input.required').on('change focusout', function () {
          t.valid()
        ...
        t.find('.fake_btn_cv').on('click', function (e) {
          e.preventDefault(),
            t.valid() &&
              ($('.fake_btn_cv').addClass('d-none'),
              $('.g-recaptcha.cvBTN').removeClass('d-none'),
              $(this)
                .next('button.g-recaptcha.cvBTN')
                .trigger('click')
                .remove());
        });
    }),
    $('#subscribe-popup-form').length > 0 &&
      $('#subscribePopupModal').on('show.bs.modal', function (e) {
        var t = $('#subscribe-popup-form');
        t.validate({
          onfocusout: function (e) {
            $(e).valid();
          },
          ...
          t.find('.required').on('change focusout', function () {
            t.valid() &&
            t.find('select.required').val() &&
            t.find('select.required').val().length > 0
          ...
          t.find('.fake_btn_subscribe').on('click', function (e) {
            e.preventDefault(),
              t.valid() &&
                t.find('select.required').val() &&
                t.find('select.required').val().length > 0 &&
...
!(function (e, t) {
          ...
          if (null != (e = arguments[a]))
            for (t in e)
              (i = e[t]),
                '__proto__' !== t &&
                  r !== i &&
                  (d && i && (w.isPlainObject(i) || (s = Array.isArray(i)))
                    ? ((n = r[t]),
                      (o =
                        s && !Array.isArray(n)
                          ? []
  ...
  var x = (function (e) {
    ...
    try {
      M.apply(($ = L.call(w.childNodes)), w.childNodes),
    ...
    function ae(e, t, i, s) {
      ...
      if (!s && (h(t), (t = t || f), m)) {
        if (11 !== w && (c = J.exec(e)))
          if ((o = c[1])) {
            if (9 === w) {
              if (!(d = t.getElementById(o))) return i;
              if (d.id === o) return i.push(d), i;
    ...
    (ae.attr = function (e, t) {
      ...
      var s = i.attrHandle[t.toLowerCase()],
        o = s && S.call(i.attrHandle, t.toLowerCase()) ? s(e, t, !m) : void 0;
      return void 0 !== o
        ? o
        : n.attributes || !m
        ? e.getAttribute(t)
                    ...
                    if (((p = [r ? g.firstChild : g.lastChild]), r && y)) {
                      ...
                      (y &&
                        (b = f =
                          (d =
                            (u =
                              (c = (h = t)[_] || (h[_] = {}))[h.uniqueID] ||
                              (c[h.uniqueID] = {}))[e] || [])[0] === C && d[1]),
                      !1 === b)
                    )
                      for (
                        ;
    ...
    function Ce(e, t, n, i, s) {
      for (var o, r = [], a = 0, l = e.length, d = null != t; a < l; a++)
        (o = e[a]) && ((n && !n(o, i, s)) || (r.push(o), d && t.push(a)));
      return r;
    }
      ...
      return (
        ...
        de(function (o, r, a, l) {
          var d,
            ...
            v = n ? (s || (o ? e : p || i) ? [] : r) : g;
          if ((n && n(g, v, a, l), i))
            for (d = Ce(v, f), i(d, [], a, l), u = d.length; u--; )
              (c = d[u]) && (v[f[u]] = !(g[f[u]] = c));
          if (o) {
            if (s || e) {
              if (s) {
          ...
          } else (v = Ce(v === r ? v.splice(p, v.length) : v)), s ? s(null, r, v, l) : M.apply(r, v);
        })
      );
    }
    function Te(e) {
      ...
      (r = ae.tokenize =
        function (e, t) {
          ...
          for (a = e, l = [], d = i.preFilter; a; ) {
            for (r in ((n && !(s = U.exec(a))) ||
              (s && (a = a.slice(s[0].length) || a), l.push((o = []))),
            (n = !1),
            (s = B.exec(a)) &&
              ((n = s.shift()),
              o.push({ value: n, type: s[0].replace(z, ' ') }),
              (a = a.slice(n.length))),
            i.filter))
              !(s = Y[r].exec(a)) ||
                (d[r] && !(s = d[r](s))) ||
            ...
            (g = E(
              ...
              (u = function (e, t, n, r, u) {
                ...
                for (
                  ...
                  if (l && c) {
                    for (
                      p = 0, t || c.ownerDocument == f || (h(c), (n = !m));
                      (g = s[p++]);
                ...
                if (((v += y), a && y !== v)) {
                  ...
                  if (e) {
                    if (0 < v) for (; y--; ) b[y] || _[y] || (_[y] = N.call(r));
                    _ = Ce(_);
                  }
                  M.apply(r, _),
                    u &&
          ...
          if (((n = n || []), 1 === f.length)) {
            ...
            for (
              ...
              if (
                ...
                if ((l.splice(o, 1), !(e = s.length && be(l))))
  ...
  (w.filter = function (e, t, n) {
    ...
    w.fn.extend({
      ...
      is: function (e) {
        return !!S(this, 'string' == typeof e && E.test(e) ? w(e) : e || [], !1)
          .length;
      },
    });
  var $,
      ...
      function (e, t) {
        w.fn[e] = function (n, i) {
          ...
          return (
            ...
            1 < this.length &&
              (M[e] || w.uniqueSort(s), j.test(e) && s.reverse()),
            this.pushStack(s)
          );
        };
      }
  ...
  (w.Callbacks = function (e) {
    ...
    var i,
      ...
      d = -1,
      u = function () {
        for (r = r || e.once, o = i = !0; l.length; d = -1)
          for (s = l.shift(); ++d < a.length; )
            !1 === a[d].apply(s[0], s[1]) &&
              e.stopOnFalse &&
              ((d = a.length), (s = !1));
    ...
    w.extend({
        ...
        var n = [
          ...
          s = {
            ...
            then: function (t, i, s) {
                    ...
                    d = function () {
                      ...
                      if (!(t < o)) {
                        ...
                        (d =
                          ...
                          p(d)
                            ? s
                              ? d.call(e, r(o, n, P, s), r(o, n, I, s))
                              : (o++,
                                d.call(
                                  e,
                                  r(o, n, P, s),
                                  r(o, n, I, s),
                                  r(o, n, P, n.notifyWith)
                                ))
                            : (i !== P && ((a = void 0), (l = [e])),
                              (s || n.resolveWith)(a, l));
                      }
              ...
              return w
                .Deferred(function (e) {
                  n[0][3].add(r(0, e, p(s) ? s : P, e.notifyWith)),
                    n[1][3].add(r(0, e, p(t) ? t : P)),
                    n[2][3].add(r(0, e, p(i) ? i : I));
                })
                .promise();
            },
            promise: function (e) {
      ...
      when: function (e) {
        ...
        if (
          t <= 1 &&
          (F(e, r.done(a(n)).resolve, r.reject, !t),
          'pending' === r.state() || p(o[n] && o[n].then))
        )
          return r.then();
        for (; n--; ) F(o[n], a(n), r.reject);
        return r.promise();
      },
    });
  ...
  var z = function (e, t, n, i, s, o, r) {
      var a = 0,
        l = e.length,
        d = null == n;
      if ('object' === b(n))
        for (a in ((s = !0), n)) z(e, t, a, n[a], !0, o, r);
      else if (
        void 0 !== i &&
        ((s = !0),
        p(i) || (r = !0),
    ...
    w.fn.extend({
      data: function (e, t) {
        ...
        if (void 0 === e) {
          if (
            this.length &&
            ((s = X.get(o)), 1 === o.nodeType && !Z.get(o, 'hasDataAttrs'))
          ) {
            for (n = r.length; n--; )
              r[n] &&
    ...
    if (u && u[3] !== d) {
      for (l /= 2, d = d || u[3], u = +l || 1; r--; )
        w.style(e, t, u + d),
          ...
          (u /= o);
      (u *= 2), w.style(e, t, u + d), (n = n || []);
    }
    return (
      n &&
        ((u = +u || +l || 0),
        (s = n[1] ? u + (n[1] + 1) * n[2] : +n[2]),
        i && ((i.unit = d), (i.start = u), (i.end = s))),
      s
    );
  }
  var le = {};
  function de(e, t) {
    for (var n, i, s, o, r, a, l, d = [], u = 0, c = e.length; u < c; u++)
      (i = e[u]).style &&
        ((n = i.style.display),
        t
          ? ('none' === n &&
              ((d[u] = Z.get(i, 'display') || null),
              d[u] || (i.style.display = '')),
            '' === i.style.display &&
              re(i) &&
              (d[u] =
                ...
                (l = le[a]) ||
                  ...
                  'none' === l && (l = 'block'),
                  (le[a] = l)))))
          : 'none' !== n && ((d[u] = 'none'), Z.set(i, 'display', n)));
  ...
  (ue = g.createDocumentFragment().appendChild(g.createElement('div'))),
    (ce = g.createElement('input')).setAttribute('type', 'radio'),
      ...
      if ((o = e[f]) || 0 === o)
        if ('object' === b(o)) w.merge(h, o.nodeType ? [o] : o);
          ...
          for (
            ...
            r = r.lastChild;
          w.merge(h, r.childNodes), ((r = c.firstChild).textContent = '');
        } else h.push(t.createTextNode(o));
    for (c.textContent = '', f = 0; (o = h[f++]); )
      if (i && -1 < w.inArray(o, i)) s && s.push(o);
      else if (
        ((d = se(o)), (r = ge(c.appendChild(o), 'script')), d && ve(r), n)
      )
          ...
          handler: function (e) {
            ...
            if (1 & e.isTrigger && this[t]) {
              if (r.length)
                ...
                (i = n(this, t)),
                this[t](),
                r !== (o = Z.get(this, t)) || i ? Z.set(this, t, !1) : (o = {}),
                r !== o)
              )
                return (
  ...
  (w.event = {
      ...
      if (g && (l = g.events)) {
        for (d = (t = (t || '').match(O) || ['']).length; d--; )
          if (
            ...
            for (
              c = w.event.special[f] || {},
                h = l[(f = (i ? c.delegateType : c.bindType) || f)] || [],
                a =
                  a[2] &&
                  new RegExp('(^|\\.)' + p.join('\\.(?:.*\\.|)') + '(\\.|$)'),
                r = o = h.length;
            ...
            r &&
              !h.length &&
              ((c.teardown && !1 !== c.teardown.call(e, p, g.handle)) ||
                w.removeEvent(e, f, g.handle),
              delete l[f]);
          } else for (f in l) w.event.remove(e, f + t[d], n, i, !0);
    ...
    dispatch: function (e) {
      ...
      if (
        ...
        for (
          r = w.event.handlers.call(this, l, d), t = 0;
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            he.test(t.type) && t.click && D(t, 'input') && ke(t, 'click', we),
            !1
          );
        },
        trigger: function (e) {
  ...
  function Me(e, t, n, i) {
    ...
    var s,
      ...
      g = t[0],
      v = p(g);
    if (v || (1 < h && 'string' == typeof g && !f.checkClone && De.test(g)))
      return e.each(function (s) {
        var o = e.eq(s);
        v && (t[0] = g.call(this, s, o.html())), Me(o, t, n, i);
      });
    if (
      h &&
      ((r = (s = be(t, e[0].ownerDocument, !1, e, i)).firstChild),
      1 === s.childNodes.length && (s = r),
      r || i)
    ) {
      for (l = (a = w.map(ge(s, 'script'), $e)).length; c < h; c++)
        (d = s),
          c !== m &&
            ((d = w.clone(d, !0, !0)), l && w.merge(a, ge(d, 'script'))),
          n.call(e[c], d, c);
      if (l)
        for (u = a[a.length - 1].ownerDocument, w.map(a, Ne), c = 0; c < l; c++)
          (d = a[c]),
            pe.test(d.type || '') &&
              ...
              (d.src && 'module' !== (d.type || '').toLowerCase()
                ...
                : y(d.textContent.replace(Ae, ''), d, u));
    }
    return e;
  }
  function Le(e, t, n) {
  ...
  w.extend({
    ...
    clone: function (e, t, n) {
      ...
      if (
        ...
        for (r = ge(u), i = 0, s = (o = ge(e)).length; i < s; i++)
          (a = o[i]),
            'input' === (d = (l = r[i]).nodeName.toLowerCase()) &&
            he.test(a.type)
              ? (l.checked = a.checked)
              : ('input' !== d && 'textarea' !== d) ||
      ...
      if (t)
        if (n)
          for (o = o || ge(e), r = r || ge(u), i = 0, s = o.length; i < s; i++)
            je(o[i], r[i]);
        else je(e, u);
      return (
        0 < (r = ge(u, 'script')).length && ve(r, !c && ge(e, 'script')), u
      );
    },
  ...
  function Je(e, t, n) {
    ...
    return (
      ((!f.boxSizingReliable() && s) ||
        ...
        (o = a in e) && (r = e[a])),
      (r = parseFloat(r) || 0) +
        Ge(e, t, n || (s ? 'border' : 'content'), o, i, r) +
        'px'
    );
  }
    ...
    style: function (e, t, n, i) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var s,
          ...
          d = e.style;
        if (
          (l || (t = Qe(a)), (r = w.cssHooks[t] || w.cssHooks[a]), void 0 === n)
        )
          return r && 'get' in r && void 0 !== (s = r.get(e, !1, i)) ? s : d[t];
        'string' == (o = typeof n) &&
          (s = te.exec(n)) &&
          s[1] &&
          ((n = ae(e, t, s)), (o = 'number')),
  ...
  function ct(e, t, n) {
    var i,
      ...
      l = function () {
        ...
        return (
          ...
          i < 1 && r
            ? n
            : (r || a.notifyWith(e, [d, 1, 0]), a.resolveWith(e, [d]), !1)
        );
      },
      d = a.promise({
        elem: e,
    ...
    for (
      ...
      if ((i = ct.prefilters[o].call(d, e, u, d.opts)))
        return (
          p(i.stop) &&
            (w._queueHooks(d.elem, d.opts.queue).stop = i.stop.bind(i)),
          i
        );
    return (
      w.map(u, ut, d),
      p(d.opts.start) && d.opts.start.call(e, d),
      d
        .progress(d.opts.progress)
        .done(d.opts.done, d.opts.complete)
        .fail(d.opts.fail)
        .always(d.opts.always),
      w.fx.timer(w.extend(l, { elem: e, anim: d, queue: d.opts.queue })),
      d
    );
  }
      ...
      toggleClass: function (e, t) {
        ...
        return p(e)
          ...
          : ((n = yt(e)),
            this.each(function () {
              if (a)
                for (o = w(this), s = 0; s < n.length; s++)
                  (i = n[s]), o.hasClass(i) ? o.removeClass(i) : o.addClass(i);
              else
                (void 0 !== e && 'boolean' !== r) ||
                  ((i = vt(this)) && Z.set(this, '__className__', i),
                  this.setAttribute &&
                    this.setAttribute(
                      'class',
                      i || !1 === e ? '' : Z.get(this, '__className__') || ''
                    ));
            }));
      },
      hasClass: function (e) {
  ...
  w.extend(w.event, {
    trigger: function (t, n, i, s) {
      ...
      if (
        ...
        if (!s && !h.noBubble && !m(i)) {
          for (
            l = h.delegateType || y, _t.test(l + y) || (r = r.parentNode);
            r;
            r = r.parentNode
          )
            v.push(r), (a = r);
        ...
        for (o = 0; (r = v[o++]) && !t.isPropagationStopped(); )
          (f = r),
            ...
            (c =
              (Z.get(r, 'events') || Object.create(null))[t.type] &&
              Z.get(r, 'handle')) && c.apply(r, n),
            (c = d && r[d]) &&
              c.apply &&
              Q(r) &&
    ...
    w.extend({
      ...
      ajax: function (t, n) {
        ...
        var i,
          ...
          f = w.ajaxSetup({}, n),
          p = f.context || f,
          m = f.context && (p.nodeType || p.jquery) ? w(p) : w.event,
          v = w.Deferred(),
        ...
        if (f.beforeSend && (!1 === f.beforeSend.call(p, T, f) || d))
          return T.abort();
        if (
          ((x = 'abort'),
          y.add(f.complete),
          ...
          if (((T.readyState = 1), u && m.trigger('ajaxSend', [T, f]), d))
            return T;
          f.async &&
            0 < f.timeout &&
            ...
            c
              ? (f.ifModified &&
                  ((C = T.getResponseHeader('Last-Modified')) &&
                    (w.lastModified[s] = C),
                  (C = T.getResponseHeader('etag')) && (w.etag[s] = C)),
                204 === t || 'HEAD' === f.type
                  ? (x = 'nocontent')
                  : 304 === t
                  ? (x = 'notmodified')
                  : ((x = _.state), (h = _.data), (c = !(g = _.error))))
              : ((g = x), (!t && x) || ((x = 'error'), t < 0 && (t = 0))),
            (T.status = t),
            (T.statusText = (n || x) + ''),
            c ? v.resolveWith(p, [h, x, T]) : v.rejectWith(p, [T, x, g]),
            T.statusCode(b),
            (b = void 0),
            u && m.trigger(c ? 'ajaxSuccess' : 'ajaxError', [T, f, c ? h : g]),
            y.fireWith(p, [T, x]),
            u &&
  ...
  w.ajaxSetup({
        ...
        return (
          ...
          i.always(function () {
            void 0 === o ? w(e).removeProp(s) : (e[s] = o),
              t[s] && ((t.jsonpCallback = n.jsonpCallback), Vt.push(s)),
              r && p(o) && o(r[0]),
              (r = o = void 0);
          }),
          'script'
    ...
    w.each(['top', 'left'], function (e, t) {
      w.cssHooks[t] = Ue(f.pixelPosition, function (e, n) {
        if (n)
          return (n = ze(e, t)), Oe.test(n) ? w(e).position()[t] + 'px' : n;
      });
    }),
  ...
  return (
    (w.noConflict = function (t) {
      return e.$ === w && (e.$ = Xt), t && e.jQuery === w && (e.jQuery = Zt), w;
    }),
  ...
  (function (e) {
    ...
    e.migrateVersion = '3.4.0';
    var i = Object.create(null),
      s =
        ((e.migrateDisablePatches = function () {
          for (var e = 0; e < arguments.length; e++) i[arguments[e]] = !0;
        }),
        (e.migrateEnablePatches = function () {
          for (var e = 0; e < arguments.length; e++) delete i[arguments[e]];
        }),
    ...
    function o(n, i) {
      ...
      !e.migrateIsPatchEnabled(n) ||
        (e.migrateDeduplicateWarnings && s[i]) ||
        ((s[i] = !0),
        e.migrateWarnings.push(i + ' [' + n + ']'),
        o &&
          o.warn &&
          !e.migrateMute &&
          (o.warn('JQMIGRATE: ' + i), e.migrateTrace && o.trace && o.trace()));
    }
    ...
    function a(t, n, i, s, r) {
      var a = t[n];
      t[n] = function () {
        return (
          r && o(s, r),
          (e.migrateIsPatchEnabled(s) ? i : a || e.noop).apply(this, arguments)
        );
      };
    }
    ...
    (e.migrateDeduplicateWarnings = !0),
      ...
      'BackCompat' === t.document.compatMode &&
        o('quirks', 'jQuery is not compatible with Quirks Mode');
    var u,
      c,
      h,
      f = {},
      ...
      function (t) {
        ...
        return (
          e.migrateIsPatchEnabled('selector-empty-id') &&
            'string' == typeof t &&
            '#' === t &&
            (o('selector-empty-id', "jQuery( '#' ) is not a valid selector"),
            (n[0] = [])),
          p.apply(this, n)
        );
      },
      ...
      function (e) {
        ...
        if ('string' == typeof e && g.test(e))
          try {
            ...
            e = e.replace(v, function (e, t, n, i) {
              return '[' + t + n + '"' + i + '"]';
            });
            try {
              t.document.querySelector(e),
    ...
    m))
      Object.prototype.hasOwnProperty.call(m, u) && (e.find[u] = m[u]);
    l(
      e.fn,
      'size',
      function () {
    ...
    d(
      ...
      function (t) {
        var n = this;
        return (
          e.each(t.match(w), function (t, i) {
            e.expr.match.bool.test(i) &&
              (o(
                'removeAttr-bool',
                'jQuery.fn.removeAttr no longer sets boolean properties: ' + i
              ),
              n.prop(i, !1));
          }),
    ...
    e.swap &&
      ...
      d(
        ...
        function (e, t, n, i) {
          var s,
            r = {};
          for (s in (T ||
            o('swap', 'jQuery.swap() is undocumented and deprecated'),
          t))
            (r[s] = e.style[s]), (e.style[s] = t[s]);
          for (s in ((n = n.apply(e, i || [])), t)) e.style[s] = r[s];
          return n;
        },
        'swap'
      ),
      n('3.4.0') &&
        ...
        (e.cssProps = new Proxy(e.cssProps || {}, {
          set: function () {
            return (
              o('cssProps', 'jQuery.cssProps is deprecated'),
      ...
      n('4.0.0') &&
        ...
        (e.cssNumber = new Proxy(
          ...
          },
          {
            get: function () {
              return (
                o('css-number', 'jQuery.cssNumber is deprecated'),
      ...
      d(
        ...
        function (t, n) {
          ...
          return t && 'object' == typeof t && !Array.isArray(t)
            ...
            : ('number' == typeof n &&
                ((i = n = C(t)),
                (k.test(i) && E.test(i[0].toUpperCase() + i.slice(1))) ||
                  e.cssNumber[n] ||
                  o(
                    'css-number',
    ...
    var A,
        ...
        (d(
          ...
          function (t, n, i) {
            ...
            if (n && 'object' == typeof n && 2 === arguments.length) {
              for (a in ((s = e.hasData(t) && O.call(this, t)), (r = {}), n))
                a !== C(a)
                  ? (o(
                      'data-camelCase',
                    ...
                    (s[a] = n[a]))
                  : (r[a] = n[a]);
              return O.call(this, t, r), n;
            }
            return n &&
              'string' == typeof n &&
              n !== C(n) &&
              (s = e.hasData(t) && O.call(this, t)) &&
              n in s
              ? (o(
                  'data-camelCase',
                  'jQuery.data() always sets/gets camelCased names: ' + n
                ),
                2 < arguments.length && (s[n] = i),
                s[n])
        ...
        e.fx &&
          ...
          t.requestAnimationFrame &&
            Object.defineProperty(e.fx, 'interval', {
              ...
              get: function () {
                return (
                  t.document.hidden || o('fx-interval', S),
                  e.migrateIsPatchEnabled('fx-interval') && void 0 === A
                    ? 13
                    : A
                );
              },
      ...
      R =
          ...
          function (t) {
            ...
            if (s.length)
              for (
                o(
                  'event-old-patch',
                  'jQuery.event.props are deprecated and removed: ' + s.join()
                );
                s.length;
            ...
            return (n = F.call(this, t)), i && i.filter ? i.filter(n, t) : n;
          },
          'event-old-patch'
        ),
        d(
        ...
        (e.event.special.ready = {
          setup: function () {
            this === t.document &&
              o('ready-event', "'ready' event is deprecated");
          },
        }),
        l(
          e.fn,
      ...
      e.Deferred &&
        ...
        d(
          ...
          function (t) {
            ...
            return (
              l(n, 'pipe', s, 'deferred-pipe', 'deferred.pipe() is deprecated'),
              l(i, 'pipe', s, 'deferred-pipe', 'deferred.pipe() is deprecated'),
              t && t.call(n, n),
              n
            );
          },
  ...
  (function (e, t) {
    ...
    var d = 'bs.alert',
      ...
      c = (function () {
        ...
        return (
          ...
          (t.dispose = function () {
            n.default.removeData(this._element, d), (this._element = null);
          }),
          ...
          (t._removeElement = function (e) {
            var t = this;
            if (
              (n.default(e).removeClass('show'), n.default(e).hasClass('fade'))
            ) {
    ...
    n
      ...
      (n.default.fn.alert = c._jQueryInterface),
      (n.default.fn.alert.Constructor = c),
      (n.default.fn.alert.noConflict = function () {
        return (n.default.fn.alert = u), c._jQueryInterface;
      });
    var h = 'bs.button',
      f = n.default.fn.button,
      p = 'active',
      ...
      y = (function () {
        ...
        return (
          (t.toggle = function () {
            ...
            if (i) {
              var s = this._element.querySelector(g);
              if (s) {
                if ('radio' === s.type)
                  if (s.checked && this._element.classList.contains(p)) e = !1;
                  else {
                    var o = i.querySelector('.active');
                    o && n.default(o).removeClass(p);
                  }
                e &&
                  (('checkbox' !== s.type && 'radio' !== s.type) ||
                    (s.checked = !this._element.classList.contains(p)),
                  this.shouldAvoidTriggerChange ||
                    n.default(s).trigger('change')),
                  s.focus(),
                  (t = !1);
              }
            }
          ...
          (t.dispose = function () {
            n.default.removeData(this._element, h), (this._element = null);
          }),
          (e._jQueryInterface = function (t, i) {
            return this.each(function () {
              var s = n.default(this),
                o = s.data(h);
              o || ((o = new e(this)), s.data(h, o)),
    ...
    n
      ...
      .on('click.bs.button.data-api', m, function (e) {
        var t = e.target,
          i = t;
        if (
          (n.default(t).hasClass('btn') || (t = n.default(t).closest(v)[0]),
          ...
          ('INPUT' !== i.tagName && 'LABEL' === t.tagName) ||
      ...
      (n.default.fn.button = y._jQueryInterface),
      (n.default.fn.button.Constructor = y),
      (n.default.fn.button.noConflict = function () {
        return (n.default.fn.button = f), y._jQueryInterface;
      });
    var b = 'carousel',
      _ = 'bs.carousel',
      w = n.default.fn[b],
        ...
        return (
          ...
          (t.to = function (e) {
            ...
            if (!(e > this._items.length - 1 || e < 0))
              if (this._isSliding)
                n.default(this._element).one(k, function () {
                  return t.to(e);
                });
              else {
          ...
          (t.dispose = function () {
            n.default(this._element).off('.bs.carousel'),
              n.default.removeData(this._element, _),
              (this._items = null),
              (this._config = null),
              (this._element = null),
              (this._interval = null),
          ...
          (t._getConfig = function (e) {
            return (e = o({}, D, e)), l.typeCheckConfig(b, e, A), e;
          }),
          ...
          (t._addTouchEventListeners = function () {
            ...
            if (this._touchSupported) {
              var t = function (t) {
                  e._pointerEvent &&
                  S[t.originalEvent.pointerType.toUpperCase()]
          ...
          (t._getItemByDirection = function (e, t) {
            ...
            if (((i && 0 === s) || (n && s === o)) && !this._config.wrap)
              return t;
            var r = (s + (e === T ? -1 : 1)) % this._items.length;
            return -1 === r
          ...
          (t._triggerSlideEvent = function (e, t) {
            var i = this._getItemIndex(e),
              s = this._getItemIndex(this._element.querySelector(E)),
              o = n.default.Event('slide.bs.carousel', {
                relatedTarget: e,
                direction: t,
                from: s,
                to: i,
          ...
          (t._setActiveIndicatorElement = function (e) {
            if (this._indicatorsElement) {
              ...
              n.default(t).removeClass(C);
              var i = this._indicatorsElement.children[this._getItemIndex(e)];
              i && n.default(i).addClass(C);
            }
          }),
          ...
          (t._slide = function (e, t) {
            var i,
              ...
              o,
              r = this,
              a = this._element.querySelector(E),
            ...
            if (
              ...
              if (n.default(this._element).hasClass('slide')) {
                n.default(u).addClass(s),
                  l.reflow(u),
                  n.default(a).addClass(i),
                  n.default(u).addClass(i);
                ...
                n.default(a)
                  .one(l.TRANSITION_END, function () {
                    n
                      ...
                      .removeClass(i + ' ' + s)
                      .addClass(C),
                      n.default(a).removeClass('active ' + s + ' ' + i),
                      (r._isSliding = !1),
                      setTimeout(function () {
                        return n.default(r._element).trigger(f);
                      }, 0);
                  })
                  .emulateTransitionEnd(p);
              } else
                n.default(a).removeClass(C),
                  n.default(u).addClass(C),
                  (this._isSliding = !1),
          ...
          (e._jQueryInterface = function (t) {
            return this.each(function () {
              var i = n.default(this).data(_),
                s = o({}, D, n.default(this).data());
              'object' == typeof t && (s = o({}, s, t));
              var r = 'string' == typeof t ? t : s.slide;
              if (
                (i || ((i = new e(this, s)), n.default(this).data(_, i)),
                'number' == typeof t)
              )
                i.to(t);
          ...
          (e._dataApiClickHandler = function (t) {
            ...
            if (i) {
              ...
              if (s && n.default(s).hasClass('carousel')) {
                var r = o({}, n.default(s).data(), n.default(this).data()),
                  a = this.getAttribute('data-slide-to');
                a && (r.interval = !1),
                  e._jQueryInterface.call(n.default(s), r),
                  a && n.default(s).data(_).to(a),
                  t.preventDefault();
              }
            }
          }),
    ...
    n
      ...
      (n.default.fn[b] = $._jQueryInterface),
      (n.default.fn[b].Constructor = $),
      (n.default.fn[b].noConflict = function () {
        return (n.default.fn[b] = w), $._jQueryInterface;
      });
    var N = 'collapse',
      j = 'bs.collapse',
      M = n.default.fn[N],
        ...
        return (
            ...
            if (
              !(
                ...
                (this._parent &&
                  ...
                  (t = null),
                t &&
                  (i = n.default(t).not(this._selector).data(j)) &&
                  i._isTransitioning)
              )
            ) {
              var o = n.default.Event('show.bs.collapse');
              if (
                (n.default(this._element).trigger(o), !o.isDefaultPrevented())
              ) {
                t &&
                  ...
                  i || n.default(t).data(j, null));
                var r = this._getDimension();
                n.default(this._element).removeClass(O).addClass(P),
                ...
                n
                  ...
                  .one(l.TRANSITION_END, function () {
                    n
                      ...
                      n.default(s._element).trigger('shown.bs.collapse');
                  })
          ...
          (t.hide = function () {
            ...
            if (
              ...
              if (
                (n.default(this._element).trigger(t), !t.isDefaultPrevented())
              ) {
                  ...
                  for (var o = 0; o < s; o++) {
                    ...
                    null !== a &&
                      (n
                        ...
                        .hasClass(L) ||
                        n.default(r).addClass(I).attr('aria-expanded', !1));
                  }
          ...
          (t._getConfig = function (e) {
            return (
              ...
              l.typeCheckConfig(N, e, H),
              e
            );
          }),
          (t._getDimension = function () {
            return n.default(this._element).hasClass(F) ? F : 'height';
          }),
          (t._getParent = function () {
            ...
            var s =
                ...
                this._config.parent +
                '"]',
              o = [].slice.call(t.querySelectorAll(s));
            return (
          ...
          (t._addAriaAndCollapsedClass = function (e, t) {
            ...
            t.length &&
              n.default(t).toggleClass(I, !i).attr('aria-expanded', i);
          }),
          ...
          (e._jQueryInterface = function (t) {
            return this.each(function () {
              var i = n.default(this),
                s = i.data(j),
                r = o({}, q, i.data(), 'object' == typeof t && t ? t : {});
              if (
                (!s &&
                  r.toggle &&
                  'string' == typeof t &&
    ...
    n.default(document).on('click.bs.collapse.data-api', R, function (e) {
      ...
      (n.default.fn[N] = z._jQueryInterface),
      (n.default.fn[N].Constructor = z),
      (n.default.fn[N].noConflict = function () {
        return (n.default.fn[N] = M), z._jQueryInterface;
      });
    var U =
    ...
    function Z(e) {
      ...
      var t = Q(e),
        ...
        i = t.overflowX,
        s = t.overflowY;
      return /(auto|scroll|overlay)/.test(n + s + i) ? e : Z(Y(e));
    }
    function X(e) {
      return e && e.referenceNode ? e.referenceNode : e;
    }
    var K = U && !(!window.MSInputMethodContext || !document.documentMode),
      G = U && /MSIE 10/.test(navigator.userAgent);
    function J(e) {
    ...
    function ee(e) {
      ...
      for (
        var t = J(10) ? document.body : null, n = e.offsetParent || null;
    ...
    function ne(e, t) {
      ...
      if ((e !== l && t !== l) || i.contains(s))
        return 'BODY' === (a = (r = l).nodeName) ||
          ('HTML' !== a && ee(r.firstElementChild) !== r)
          ? ee(l)
          : l;
      var d = te(e);
      return d.host ? ne(d.host, t) : ne(e, te(t).host);
    }
    function ie(e) {
      var t =
    ...
    function ae(e) {
      ...
      return { height: re('Height', t, n, i), width: re('Width', t, n, i) };
    }
    var le = function (e, t) {
        if (!(e instanceof t))
    ...
    function fe(e) {
      ...
      if (l || d) {
        var u = Q(e);
        (l -= oe(u, 'x')), (d -= oe(u, 'y')), (s.width -= l), (s.height -= d);
      }
      return he(s);
    }
    function pe(e, t) {
    ...
    function ye(e, t, n, i) {
      var s = arguments.length > 4 && void 0 !== arguments[4] && arguments[4],
        o = { top: 0, left: 0 },
        r = s ? ve(e) : ne(e, X(t));
      if ('viewport' === i) o = me(r, s);
      else {
        var a = void 0;
        'scrollParent' === i
          ? 'BODY' === (a = Z(Y(t))).nodeName &&
            (a = e.ownerDocument.documentElement)
          : (a = 'window' === i ? e.ownerDocument.documentElement : i);
        var l = pe(a, r, s);
        if ('HTML' !== a.nodeName || ge(r)) o = l;
        else {
          var d = ae(e.ownerDocument),
            u = d.height,
            c = d.width;
    ...
    function _e(e, t, n, i, s) {
      ...
      var r = ye(n, i, o, s),
        ...
        l = Object.keys(a)
          .map(function (e) {
            return ce({ key: e }, a[e], { area: be(a[e]) });
          })
          .sort(function (e, t) {
    ...
    function Ee(e, t, n) {
      return (
        (void 0 === n
          ...
          e.enabled &&
            V(n) &&
            ((t.offsets.popper = he(t.offsets.popper)),
            (t.offsets.reference = he(t.offsets.reference)),
            (t = n(t, e)));
        }),
        t
      );
    ...
    function je(e, t, n, i) {
      (n.updateBound = i),
        Ne(e).addEventListener('resize', n.updateBound, { passive: !0 });
      var s = Z(e);
      return (
        (function e(t, n, i, s) {
    ...
    function Le() {
      ...
      this.state.eventsEnabled &&
        ...
        (this.state =
          ((e = this.reference),
          (t = this.state),
          Ne(e).removeEventListener('resize', t.updateBound),
    ...
    var Ie = U && /Firefox/i.test(navigator.userAgent);
    function Fe(e, t, n) {
      var i = ke(e, function (e) {
          return e.name === t;
        }),
        ...
        modifiers: {
            ...
            fn: function (e) {
              ...
              if (i) {
                var s = e.offsets,
                  ...
                  u = {
                    start: ue({}, l, o[l]),
                    end: ue({}, l, o[l] + o[d] - r[d]),
                  };
                e.offsets.popper = ce({}, r, u[i]);
              }
              return e;
            },
          },
          ...
          keepTogether: {
            ...
            fn: function (e) {
              var t = e.offsets,
                ...
                d = r ? 'width' : 'height';
              return (
                n[a] < o(i[l]) && (e.offsets.popper[l] = o(i[l]) - n[d]),
          ...
          arrow: {
            ...
            fn: function (e, t) {
              ...
              var s = e.placement.split('-')[0],
                ...
                f = l ? 'bottom' : 'right',
                p = Ce(i)[d];
              a[f] - p < r[c] && (e.offsets.popper[c] -= r[c] - (a[f] - p)),
                a[c] + p > r[f] && (e.offsets.popper[c] += a[c] + p - r[f]),
              ...
              return (
                (b = Math.max(Math.min(r[d] - p, b), 0)),
                (e.arrowElement = i),
                (e.offsets.arrow =
                  (ue((n = {}), c, Math.round(b)), ue(n, h, ''), n)),
                e
              );
            },
            element: '[x-arrow]',
            ...
            fn: function (e, t) {
              ...
              return (
                r.forEach(function (a, l) {
                  ...
                  (i = e.placement.split('-')[0]), (s = xe(i));
                  var d = e.offsets.popper,
                    u = e.offsets.reference,
                    c = Math.floor,
                    h =
                      ('left' === i && c(d.right) > c(u.left)) ||
                      ('right' === i && c(d.left) < c(u.right)) ||
                      ('top' === i && c(d.bottom) > c(u.top)) ||
                      ('bottom' === i && c(d.top) < c(u.bottom)),
                    f = c(d.left) < c(n.left),
                  ...
                  (h || v || w) &&
                    ...
                    (e.offsets.popper = ce(
                      {},
                      e.offsets.popper,
                      Te(e.instance.popper, e.offsets.reference, e.placement)
                    )),
          ...
          inner: {
            ...
            fn: function (e) {
              ...
              return (
                (s[r ? 'left' : 'top'] =
                  o[n] - (a ? s[r ? 'width' : 'height'] : 0)),
                (e.placement = xe(t)),
                (e.offsets.popper = he(s)),
                e
              );
            },
          },
          ...
          computeStyle: {
            ...
            fn: function (e, t) {
              ...
              var r,
                ...
                h = (function (e, t) {
                  var n = e.offsets,
                    ...
                    h = t ? (u || c || l % 2 == d % 2 ? o : r) : a,
                    f = t ? o : a;
                  return {
                    left: h(
                      l % 2 == 1 && d % 2 == 1 && !c && t ? i.left - 1 : i.left
                    ),
                    top: f(i.top),
                    bottom: f(i.bottom),
                    right: h(i.right),
              ...
              if (
                ...
                var g = 'bottom' === f ? -1 : 1,
                  v = 'right' === p ? -1 : 1;
                (c[f] = a * g), (c[p] = r * v), (c.willChange = f + ', ' + p);
              }
              var y = { 'x-placement': e.placement };
              return (
                (e.attributes = ce({}, y, e.attributes)),
                (e.styles = ce({}, c, e.styles)),
          ...
          applyStyle: {
            ...
            onLoad: function (e, t, n, i, s) {
              var o = we(s, t, e, n.positionFixed),
                r = _e(
                  n.placement,
                  o,
                  t,
      ...
      Ue = (function () {
        function e(t, n) {
          ...
          le(this, e),
            ...
            Object.keys(ce({}, e.Defaults.modifiers, s.modifiers)).forEach(
              function (t) {
                i.options.modifiers[t] = ce(
                  {},
        ...
        return (
          (t.toggle = function () {
            if (
              ...
              !n.default(this._element).hasClass(Ze)
            ) {
              var t = n.default(this._menu).hasClass(Xe);
          ...
          (t.show = function (t) {
            if (
              ...
              !(
                this._element.disabled ||
                n.default(this._element).hasClass(Ze) ||
                n.default(this._menu).hasClass(Xe)
              ))
            ) {
              var i = { relatedTarget: this._element },
                s = n.default.Event('show.bs.dropdown', i),
                o = e._getParentFromElement(this._element);
              if ((n.default(o).trigger(s), !s.isDefaultPrevented())) {
                if (!this._inNavbar && t) {
                  if (void 0 === Be)
                    throw new TypeError(
                ...
                'ontouchstart' in document.documentElement &&
                  ...
                  n.default(this._menu).toggleClass(Xe),
                  n
                    .default(o)
                    .toggleClass(Xe)
          ...
          (t.hide = function () {
            if (
              ...
              var t = { relatedTarget: this._element },
                i = n.default.Event(Ge, t),
                s = e._getParentFromElement(this._element);
              n.default(s).trigger(i),
                i.isDefaultPrevented() ||
                  (this._popper && this._popper.destroy(),
                  n.default(this._menu).toggleClass(Xe),
                  n.default(s).toggleClass(Xe).trigger(n.default.Event(Je, t)));
            }
          }),
          (t.dispose = function () {
            n.default.removeData(this._element, Ve),
          ...
          (t._getConfig = function (e) {
            return (
              ...
              l.typeCheckConfig(We, e, this.constructor.DefaultType),
              e
            );
          }),
          ...
          (t._getPlacement = function () {
            ...
            return (
              e.hasClass('dropup')
                ? (t = n.default(this._menu).hasClass(Ke)
                    ? 'top-end'
                    : 'top-start')
                ...
                : e.hasClass('dropleft')
                ? (t = 'left-start')
                : n.default(this._menu).hasClass(Ke) && (t = 'bottom-end'),
              t
            );
          }),
          ...
          (e._jQueryInterface = function (t) {
            return this.each(function () {
              var i = n.default(this).data(Ve);
              if (
                (i ||
                  ((i = new e(this, 'object' == typeof t ? t : null)),
                  n.default(this).data(Ve, i)),
                'string' == typeof t)
              ) {
                if (void 0 === i[t])
                  throw new TypeError('No method named "' + t + '"');
          ...
          (e._clearMenus = function (t) {
            if (!t || (3 !== t.which && ('keyup' !== t.type || 9 === t.which)))
              for (
                var i = [].slice.call(document.querySelectorAll(nt)),
                  s = 0,
                  o = i.length;
                s < o;
                s++
                ...
                var r = e._getParentFromElement(i[s]),
                  a = n.default(i[s]).data(Ve),
                  l = { relatedTarget: i[s] };
                if ((t && 'click' === t.type && (l.clickEvent = t), a)) {
                  var d = a._menu;
                  if (
                    n.default(r).hasClass(Xe) &&
                    !(
                      t &&
                      (('click' === t.type &&
                        /input|textarea/i.test(t.target.tagName)) ||
                        ('keyup' === t.type && 9 === t.which)) &&
                      n.default.contains(r, t.target)
                    )
                  ) {
                    var u = n.default.Event(Ge, l);
                    n.default(r).trigger(u),
                      u.isDefaultPrevented() ||
                        ...
                        n.default(d).removeClass(Xe),
                        n
                          .default(r)
                          .removeClass(Xe)
                          .trigger(n.default.Event(Je, l)));
                  }
                }
              }
          }),
                ...
                ? 32 === t.which ||
                  (27 !== t.which &&
                    ((40 !== t.which && 38 !== t.which) ||
                      n.default(t.target).closest(it).length))
                : !Ye.test(t.which)) &&
              !this.disabled &&
              !n.default(this).hasClass(Ze)
            ) {
              var i = e._getParentFromElement(this),
                s = n.default(i).hasClass(Xe);
              if (s || 27 !== t.which) {
                if (
                  (t.preventDefault(),
                  t.stopPropagation(),
                  !s || 27 === t.which || 32 === t.which)
                )
                  return (
                    27 === t.which &&
                      n.default(i.querySelector(nt)).trigger('focus'),
    ...
    n
      ...
      .on(et + ' keyup.bs.dropdown.data-api', rt._clearMenus)
      .on(et, nt, function (e) {
        e.preventDefault(),
          e.stopPropagation(),
          rt._jQueryInterface.call(n.default(this), 'toggle');
      })
      .on(et, '.dropdown form', function (e) {
        e.stopPropagation();
      }),
      (n.default.fn[We] = rt._jQueryInterface),
      (n.default.fn[We].Constructor = rt),
      (n.default.fn[We].noConflict = function () {
        return (n.default.fn[We] = Qe), rt._jQueryInterface;
      });
    var at = 'bs.modal',
      lt = n.default.fn.modal,
      dt = 'modal-open',
      ut = 'fade',
      ct = 'show',
      ht = 'modal-static',
        ...
        return (
          ...
          (t.show = function (e) {
            ...
            if (!this._isShown && !this._isTransitioning) {
              var i = n.default.Event(pt, { relatedTarget: e });
              n.default(this._element).trigger(i),
                i.isDefaultPrevented() ||
                  ((this._isShown = !0),
                  n.default(this._element).hasClass(ut) &&
                  ...
                  n
                    .default(this._element)
                    .on(vt, '[data-dismiss="modal"]', function (e) {
                      return t.hide(e);
                    }),
          ...
          (t.hide = function (e) {
            ...
            if (
              ...
              if (
                ...
                this._isShown = !1;
                var s = n.default(this._element).hasClass(ut);
                if (
                  (s && (this._isTransitioning = !0),
                  this._setEscapeEvent(),
                  this._setResizeEvent(),
                  n.default(document).off(mt),
                  n.default(this._element).removeClass(ct),
                  n.default(this._element).off(vt),
          ...
          (t.dispose = function () {
            [window, this._element, this._dialog].forEach(function (e) {
              ...
              n.default(document).off(mt),
              n.default.removeData(this._element, at),
              (this._config = null),
              (this._element = null),
              (this._dialog = null),
              (this._backdrop = null),
          ...
          (t._getConfig = function (e) {
            return (e = o({}, wt, e)), l.typeCheckConfig('modal', e, Ct), e;
          }),
          ...
          (t._showElement = function (e) {
            var t = this,
              i = n.default(this._element).hasClass(ut),
              s = this._dialog
            ...
            (this._element.parentNode &&
              ...
              n.default(this._dialog).hasClass('modal-dialog-scrollable') && s
                ? (s.scrollTop = 0)
                : (this._element.scrollTop = 0),
              i && l.reflow(this._element),
              n.default(this._element).addClass(ct),
          ...
          (t._setResizeEvent = function () {
            var e = this;
            this._isShown
              ? n.default(window).on(gt, function (t) {
                  return e.handleUpdate(t);
                })
              : n.default(window).off(gt);
          }),
          (t._hideModal = function () {
            ...
            (this._element.style.display = 'none'),
              ...
              (this._isTransitioning = !1),
              this._showBackdrop(function () {
                n.default(document.body).removeClass(dt),
                  e._resetAdjustments(),
                  e._resetScrollbar(),
                  n.default(e._element).trigger(ft);
              });
          }),
          ...
          (t._showBackdrop = function (e) {
            var t = this,
              i = n.default(this._element).hasClass(ut) ? ut : '';
            if (this._isShown && this._config.backdrop) {
              if (
                ...
                n.default(this._element).on(vt, function (e) {
                ...
                n.default(this._backdrop).addClass(ct),
                !e)
              )
                return;
              if (!i) return void e();
              ...
              n.default(this._backdrop).removeClass(ct);
              var o = function () {
                t._removeBackdrop(), e && e();
              };
              if (n.default(this._element).hasClass(ut)) {
          ...
          (t._setScrollbar = function () {
            ...
            n.default(document.body).addClass(dt);
          }),
          (t._resetScrollbar = function () {
            ...
            n.default(t).each(function (e, t) {
              ...
              void 0 !== i &&
                n.default(t).css('margin-right', i).removeData('margin-right');
            });
          ...
          (e._jQueryInterface = function (t, i) {
            return this.each(function () {
              ...
              if (
                (s || ((s = new e(this, r)), n.default(this).data(at, s)),
                'string' == typeof t)
              ) {
                if (void 0 === s[t])
                  throw new TypeError('No method named "' + t + '"');
    ...
    n
      ...
      .on('click.bs.modal.data-api', '[data-toggle="modal"]', function (e) {
        ...
        var r = n.default(t).data(at)
          ? 'toggle'
          : o({}, n.default(t).data(), n.default(this).data());
        ('A' !== this.tagName && 'AREA' !== this.tagName) || e.preventDefault();
        var a = n.default(t).one(pt, function (e) {
          e.isDefaultPrevented() ||
            a.one(ft, function () {
              n.default(i).is(':visible') && i.focus();
            });
        });
        xt._jQueryInterface.call(n.default(t), r, this);
      }),
      (n.default.fn.modal = xt._jQueryInterface),
      (n.default.fn.modal.Constructor = xt),
      (n.default.fn.modal.noConflict = function () {
        return (n.default.fn.modal = lt), xt._jQueryInterface;
      });
    var Tt = [
        'background',
        'cite',
      ...
      kt = /^(?:(?:https?|mailto|ftp|tel|file|sms):|[^#&/:?]*(?:[#/?]|$))/i,
      Et =
            ...
            a.forEach(function (e) {
              (function (e, t) {
                ...
                if (-1 !== t.indexOf(n))
                  return (
                    -1 === Tt.indexOf(n) ||
                    Boolean(kt.test(e.nodeValue) || Et.test(e.nodeValue))
                  );
                for (
      ...
      Ht = (function () {
        ...
        return (
          ...
          (t.toggle = function (e) {
            if (this._isEnabled)
              if (e) {
                ...
                if (n.default(this.getTipElement()).hasClass(Lt))
          ...
          (t.show = function () {
            ...
            if (this.isWithContent() && this._isEnabled) {
              ...
              o.setAttribute('id', r),
                ...
                this.setContent(),
                this.config.animation && n.default(o).addClass(Mt);
              var a =
              ...
              n.default(o).data(this.constructor.DATA_KEY, this),
                ...
                n.default(o).addClass(Lt),
                n.default(o).addClass(this.config.customClass),
                'ontouchstart' in document.documentElement &&
                  n
                    .default(document.body)
                    .children()
              ...
              if (n.default(this.tip).hasClass(Mt)) {
          ...
          (t.hide = function (e) {
            ...
            if ((n.default(this.element).trigger(s), !s.isDefaultPrevented())) {
              if (
                ...
                n.default(this.tip).hasClass(Mt))
              ) {
                var r = l.getTransitionDurationFromElement(i);
                n.default(i).one(l.TRANSITION_END, o).emulateTransitionEnd(r);
              } else o();
              this._hoverState = '';
            }
          }),
          ...
          (t._enter = function (e, t) {
            ...
            (t = t || n.default(e.currentTarget).data(i)) ||
              ((t = new this.constructor(
                e.currentTarget,
                this._getDelegateConfig()
              )),
              n.default(e.currentTarget).data(i, t)),
              e && (t._activeTrigger['focusin' === e.type ? 'focus' : Pt] = !0),
              n.default(t.getTipElement()).hasClass(Lt) || t._hoverState === Ot
                ? (t._hoverState = Ot)
          ...
          (t._leave = function (e, t) {
            ...
            (t = t || n.default(e.currentTarget).data(i)) ||
              ...
              n.default(e.currentTarget).data(i, t)),
              e &&
                (t._activeTrigger['focusout' === e.type ? 'focus' : Pt] = !1),
    ...
    (n.default.fn.tooltip = Ht._jQueryInterface),
      (n.default.fn.tooltip.Constructor = Ht),
      (n.default.fn.tooltip.noConflict = function () {
        return (n.default.fn.tooltip = $t), Ht._jQueryInterface;
      });
    var zt = 'bs.popover',
      Ut = n.default.fn.popover,
      ...
      Vt = o({}, Ht.DefaultType, { content: '(string|element|function)' }),
      Qt = {
          ...
          (o._jQueryInterface = function (e) {
            return this.each(function () {
              ...
              if (
                ...
                (t || ((t = new o(this, i)), n.default(this).data(zt, t)),
                'string' == typeof e)
              ) {
                if (void 0 === t[e])
    ...
    (n.default.fn.popover = Yt._jQueryInterface),
      (n.default.fn.popover.Constructor = Yt),
      (n.default.fn.popover.noConflict = function () {
        return (n.default.fn.popover = Ut), Yt._jQueryInterface;
      });
    var Zt = 'scrollspy',
      Xt = 'bs.scrollspy',
      Kt = n.default.fn[Zt],
      ...
      sn = (function () {
        ...
        return (
          ...
          (t.dispose = function () {
            n.default.removeData(this._element, Xt),
          ...
          (t._getConfig = function (e) {
            if (
              'string' !=
                typeof (e = o({}, tn, 'object' == typeof e && e ? e : {}))
                  .target &&
              l.isElement(e.target)
            ) {
              var t = n.default(e.target).attr('id');
              t || ((t = l.getUID(Zt)), n.default(e.target).attr('id', t)),
                (e.target = '#' + t);
            }
            return l.typeCheckConfig(Zt, e, nn), e;
          }),
          ...
          (t._activate = function (e) {
            ...
            i.hasClass('dropdown-item')
              ? (i.closest('.dropdown').find('.dropdown-toggle').addClass(Gt),
                i.addClass(Gt))
              : (i.addClass(Gt),
                i.parents(en).prev('.nav-link, .list-group-item').addClass(Gt),
                i
                  .parents(en)
                  .prev('.nav-item')
                  .children('.nav-link')
          ...
          (e._jQueryInterface = function (t) {
            return this.each(function () {
              var i = n.default(this).data(Xt);
              if (
                (i ||
                  ((i = new e(this, 'object' == typeof t && t)),
                  n.default(this).data(Xt, i)),
                'string' == typeof t)
              ) {
                if (void 0 === i[t])
                  throw new TypeError('No method named "' + t + '"');
    ...
    n.default(window).on('load.bs.scrollspy.data-api', function () {
      ...
      (n.default.fn[Zt] = sn._jQueryInterface),
      (n.default.fn[Zt].Constructor = sn),
      (n.default.fn[Zt].noConflict = function () {
        return (n.default.fn[Zt] = Kt), sn._jQueryInterface;
      });
    var on = 'bs.tab',
      rn = n.default.fn.tab,
      an = 'active',
      ...
      un = (function () {
        ...
        return (
          (t.show = function () {
            ...
            if (
              !(
                (this._element.parentNode &&
                  this._element.parentNode.nodeType === Node.ELEMENT_NODE &&
                  n.default(this._element).hasClass(an)) ||
              ...
              var t,
                i,
                s = n.default(this._element).closest('.nav, .list-group')[0],
                o = l.getSelectorFromElement(this._element);
              if (s) {
                var r = 'UL' === s.nodeName || 'OL' === s.nodeName ? dn : ln;
                i = (i = n.default.makeArray(n.default(s).find(r)))[
                  i.length - 1
                ];
              }
              var a = n.default.Event('hide.bs.tab', {
                ...
                d = n.default.Event('show.bs.tab', { relatedTarget: i });
              if (
                (i && n.default(i).trigger(a),
                n.default(this._element).trigger(d),
                ...
                var u = function () {
                  var t = n.default.Event('hidden.bs.tab', {
                    ...
                    s = n.default.Event('shown.bs.tab', { relatedTarget: i });
                  n.default(i).trigger(t), n.default(e._element).trigger(s);
                };
          ...
          (t.dispose = function () {
            n.default.removeData(this._element, on), (this._element = null);
          }),
          (t._activate = function (e, t, i) {
            var s = this,
              o = (
                !t || ('UL' !== t.nodeName && 'OL' !== t.nodeName)
                  ? n.default(t).children(ln)
                  : n.default(t).find(dn)
              )[0],
            ...
            if (o && r) {
              var d = l.getTransitionDurationFromElement(o);
              n.default(o)
                .removeClass('show')
          ...
          (t._transitionComplete = function (e, t, i) {
            if (t) {
              n.default(t).removeClass(an);
              var s = n
                .default(t.parentNode)
                .find('> .dropdown-menu .active')[0];
              s && n.default(s).removeClass(an),
                'tab' === t.getAttribute('role') &&
                  t.setAttribute('aria-selected', !1);
            }
            n.default(e).addClass(an),
            ...
            if (
              ...
              o && n.default(o).hasClass('dropdown-menu'))
            ) {
              var r = n.default(e).closest('.dropdown')[0];
              if (r) {
                var a = [].slice.call(r.querySelectorAll('.dropdown-toggle'));
                n.default(a).addClass(an);
              }
          ...
          (e._jQueryInterface = function (t) {
            return this.each(function () {
              var i = n.default(this),
                s = i.data(on);
              if (
                (s || ((s = new e(this)), i.data(on, s)), 'string' == typeof t)
              ) {
                if (void 0 === s[t])
                  throw new TypeError('No method named "' + t + '"');
                s[t]();
    ...
    n
      ...
      .on(
        ...
        function (e) {
          e.preventDefault(), un._jQueryInterface.call(n.default(this), 'show');
        }
      ),
      (n.default.fn.tab = un._jQueryInterface),
      (n.default.fn.tab.Constructor = un),
      (n.default.fn.tab.noConflict = function () {
        return (n.default.fn.tab = rn), un._jQueryInterface;
      });
    var cn = 'bs.toast',
      hn = n.default.fn.toast,
      fn = 'show',
      pn = 'showing',
      ...
      yn = (function () {
        ...
        return (
          ...
          (t.hide = function () {
            if (this._element.classList.contains(fn)) {
          ...
          (t.dispose = function () {
            this._clearTimeout(),
              ...
              n.default(this._element).off(mn),
              n.default.removeData(this._element, cn),
              (this._element = null),
              (this._config = null);
          }),
          (t._getConfig = function (e) {
          ...
          (e._jQueryInterface = function (t) {
            return this.each(function () {
              ...
              if (
                (s ||
                  ((s = new e(this, 'object' == typeof t && t)), i.data(cn, s)),
                'string' == typeof t)
              ) {
                if (void 0 === s[t])
                  throw new TypeError('No method named "' + t + '"');
    ...
    (n.default.fn.toast = yn._jQueryInterface),
      (n.default.fn.toast.Constructor = yn),
      (n.default.fn.toast.noConflict = function () {
        return (n.default.fn.toast = hn), yn._jQueryInterface;
      }),
      (e.Alert = c),
      (e.Button = y),
      (e.Carousel = $),
  ...
  (jQuery.fn.preventDoubleSubmission = function () {
    return (
      $(this).on('submit', function (e) {
        var t = $(this);
        !0 === t.data('submitted')
          ? (e.preventDefault(), console.log('prevent double submittion'))
          : t.data('submitted', !0);
      }),
      this
    );
      ...
      e.extend(e.validator, {
        ...
        prototype: {
          ...
          check: function (t) {
            ...
            o && ((d = o.call(t, d)), delete r.normalizer),
            r)) {
          ...
          defaultMessage: function (t, n) {
            ...
            return (
              'function' == typeof i
                ...
                : s.test(i) &&
                  (i = e.validator.format(i.replace(s, '{$1}'), n.parameters)),
              i
            );
          },
      ...
      e.ajaxPrefilter
        ...
        : ((n = e.ajax),
          (e.ajax = function (t) {
            ...
            return 'abort' === s
              ? (i[o] && i[o].abort(), (i[o] = n.apply(this, arguments)), i[o])
              : n.apply(this, arguments);
          })),
      e
    );
  ...
  (function (e) {
    'function' == typeof define && define.amd
      ? define(['jquery', './jquery.validate.min'], e)
      : 'object' == typeof module && module.exports
      ? (module.exports = e(require('jquery')))
      : e(jQuery);
  })(function (e) {
    return (
        ...
        e.validator.addMethod(
          ...
          e.validator.addMethod(
            ...
            function (e, n, i) {
              ...
              return (
                this.optional(n) ||
                (s.match(o).length >= i[0] && s.match(o).length <= i[1])
              );
            },
      ...
      e.validator.addMethod(
        ...
        function (t, n, i) {
          var s,
            o,
            r = 'string' == typeof i ? i.replace(/\s/g, '') : 'image/*',
            a = this.optional(n);
          if (a) return a;
          if (
            'file' === e(n).attr('type') &&
            ...
            for (
              o = new RegExp('.?(' + r + ')$', 'i'), s = 0;
              s < n.files.length;
              s++
            )
              if (!n.files[s].type.match(o)) return !1;
          return !0;
        },
      ...
      e.validator.addMethod(
        ...
        function (e, t) {
          ...
          var n,
            ...
            s = 0,
            o = i.length;
          for (n = 0; n < o; n++) s += (o - n) * i.substring(n, n + 1);
          return s % 11 == 0;
        },
      ...
      e.validator.addMethod(
        ...
        function (e, t) {
          ...
          var i,
            ...
            o,
            r,
            a = new RegExp(/^([ABCDEFGHJKLMNPQRSUVW])(\d{7})([0-9A-J])$/gi),
            l = e.substring(0, 1),
            d = e.substring(1, 8),
            u = e.substring(8, 9),
            c = 0,
          ...
          for (i = 0; i < d.length; i++)
            (s = parseInt(d[i], 10)),
              n(i) ? (h += (s *= 2) < 10 ? s : s - 9) : (c += s);
          return (
            (o = (10 - (c + h).toString().substr(-1)).toString()),
      ...
      e.validator.addMethod(
        ...
        function (e) {
          ...
          for (s = 0, o = 9, 0; s < 9; ++s, --o) r += +e.charAt(s) * o;
          for (
            (n = r % 11) >= 10 && ((n = 0), (a = 2)), r = 0, s = 0, o = 1, 0;
            s < 9;
            ++s, ++o
          )
            r += +e.charAt(s) * o;
      ...
      e.validator.addMethod(
        ...
        function (e, t) {
          ...
          for (
            ...
            (o += i.charAt(n - a) * r--), r < 2 && (r = 9);
          var l = o % 11 < 2 ? 0 : 11 - (o % 11);
          if (l !== parseInt(s.charAt(0), 10)) return !1;
          (n += 1), (i = e.substring(0, n)), (o = 0), (r = n - 7);
          for (var d = n; d >= 1; d--)
            (o += i.charAt(n - d) * r--), r < 2 && (r = 9);
          return (
            (l = o % 11 < 2 ? 0 : 11 - (o % 11)) === parseInt(s.charAt(1), 10)
          );
        },
      ...
      e.validator.addMethod(
        ...
        function (e, t, n) {
          ...
          return (
            ...
            n.unknown && (i |= 128),
            n.all && (i = 255),
            (1 & i && (/^(5[12345])/.test(e) || /^(2[234567])/.test(e))) ||
            (2 & i && /^(4)/.test(e))
              ? 16 === e.length
              : 4 & i && /^(3[47])/.test(e)
              ? 15 === e.length
              : 8 & i && /^(3(0[012345]|[68]))/.test(e)
              ? 14 === e.length
              : 16 & i && /^(2(014|149))/.test(e)
              ? 15 === e.length
              : (32 & i && /^(6011)/.test(e)) || (64 & i && /^(3)/.test(e))
              ? 16 === e.length
              : 64 & i && /^(2131|1800)/.test(e)
              ? 15 === e.length
              : !!(128 & i)
          );
        },
      ...
      e.validator.addMethod(
        ...
        function (e, t, n) {
          return (
            (n = 'string' == typeof n ? n.replace(/,/g, '|') : 'png|jpe?g|gif'),
      ...
      e.validator.addMethod(
        ...
        function (e, t) {
          ...
          if (
            ...
            !new RegExp('^[A-Z]{2}\\d{2}' + s + '$', '').test(a)
          )
            return !1;
          for (
            n = a.substring(4, a.length) + a.substring(0, 4), o = 0;
            o < n.length;
            o++
          )
            '0' !== (i = n.charAt(o)) && (d = !1),
              d || (l += '0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ'.indexOf(i));
          for (r = 0; r < l.length; r++) u = ('' + u + l.charAt(r)) % 97;
          return 1 === u;
        },
      ...
      e.validator.addMethod(
        ...
        function (t, n, i) {
          return (
            !!this.optional(n) ||
            !('file' === e(n).attr('type') && n.files && n.files.length > i)
          );
        },
      ...
      e.validator.addMethod(
        ...
        function (t, n, i) {
          ...
          if ('file' === e(n).attr('type') && n.files && n.files.length)
            for (var s = 0; s < n.files.length; s++)
              if (n.files[s].size > i) return !1;
          return !0;
        },
      ...
      e.validator.addMethod(
        ...
        function (t, n, i) {
          if (this.optional(n)) return !0;
          if ('file' === e(n).attr('type') && n.files && n.files.length)
            for (var s = 0, o = 0; o < n.files.length; o++)
              if ((s += n.files[o].size) > i) return !1;
          return !0;
        },
      ...
      e.validator.addMethod(
        ...
        function (e, t) {
          ...
          return (
            !(
              (e = e.toString().toUpperCase()).length > 10 ||
              e.length < 9 ||
              !i.test(e)
            ) &&
            ((n =
              ...
              (e = e
                ...
                ? e.substr(0, 8)
                : e.substr(0, 9)),
            'TRWAGMYFPDXBNJZSQVHLCKET'.charAt(parseInt(n, 10) % 23) === s)
          );
        },
      ...
      e.validator.addMethod(
        ...
        function (e, t) {
          ...
          return (
            !!this.optional(t) ||
            (!!(e = e.toUpperCase()).match(
              '((^[A-Z]{1}[0-9]{7}[A-Z0-9]{1}$|^[T]{1}[A-Z0-9]{8}$)|^[0-9]{8}[A-Z]{1}$)'
            ) &&
              (/^[0-9]{8}[A-Z]{1}$/.test(e)
                ? 'TRWAGMYFPDXBNJZSQVHLCKE'.charAt(e.substring(8, 0) % 23) ===
                  e.charAt(8)
                : !!/^[KLM]{1}/.test(e) &&
                  e[8] ===
                    'TRWAGMYFPDXBNJZSQVHLCKE'.charAt(e.substring(8, 1) % 23)))
          );
        },
      ...
      e.validator.addMethod(
        ...
        function (t, n, i) {
          return (
            this.optional(n) || !e.validator.methods.equalTo.call(this, t, n, i)
          );
        },
      ...
      e.validator.addMethod(
        ...
        function (e, t) {
          return (
            this.optional(t) || /^\d{2}.\d{3}-\d{3}?$|^\d{5}-?\d{3}?$/.test(e)
          );
        },
      ...
      e.validator.addMethod(
        ...
        function (e, t, n) {
          var i,
            s = void 0 === n,
            o = !s && void 0 !== n.caseSensitive && n.caseSensitive,
            r = !s && void 0 !== n.includeTerritories && n.includeTerritories,
            a = !s && void 0 !== n.includeMilitary && n.includeMilitary;
          return (
            (i =
              r || a
                ? r && a
            ...
            (i = o ? new RegExp(i) : new RegExp(i, 'i')),
            this.optional(t) || i.test(e)
          );
        },
      ...
      e.validator.addMethod(
        ...
        function (e, t) {
          return (
            this.optional(t) || /^([01]\d|2[0-3]|[0-9])(:[0-5]\d){1,2}$/.test(e)
          );
        },
          ...
          for (t = 0; t < 17; t++) {
            if (
              ...
              for (n = 0; n < a.length; n++)
                if (i.toUpperCase() === a[n]) {
                  (i = l[n]), (i *= s), isNaN(r) && 8 === n && (r = a[n]);
                  break;
                }
            } else i *= s;
            u += i;
          }
          return 10 === (o = u % 11) && (o = 'X'), o === r;
        },
  ...
  (function (e) {
    ...
    function r(t, n) {
      ...
      for (var a in ((n = new RegExp('^' + n.toLowerCase())), s))
    ...
    d.prototype = {
      ...
      _resolveViewName: function (t) {
        return (
          e.each(g.viewModes, function (n, i) {
      ...
      _process_options: function (t) {
        ...
        if (
          ...
          s.defaultViewDate = n(d, u, c);
        } else s.defaultViewDate = i();
      },
      _applyEvents: function (e) {
        for (var n, i, s, o = 0; o < e.length; o++)
          (n = e[o][0]),
            2 === e[o].length
              ? ((i = t), (s = e[o][1]))
              : 3 === e[o].length && ((i = e[o][1]), (s = e[o][2])),
            n.on(s, i);
      },
        ...
        'body' !== this.o.container && (f += o),
          ...
          'auto' !== this.o.orientation.x
            ? (this.picker.addClass(
              ...
              'right' === this.o.orientation.x && (h -= t - c))
            : d.left < 0
            ? (this.picker.addClass('datepicker-orient-left'),
              (h -= d.left - 10))
            : h + t > s
            ? (this.picker.addClass('datepicker-orient-right'), (h += c - t))
            : this.o.rtl
      ...
      getClassNames: function (t) {
        ...
        return (
          ...
          this.focusDate &&
            ...
            n.push('focused'),
          this.o.todayHighlight && s(t, a) && n.push('today'),
      ...
      _fill_yearsView: function (n, i, s, o, r, a, l) {
        for (
          ...
          (d = [i]),
            (u = null),
            b === m - f ? d.push('old') : b === g + f && d.push('new'),
            -1 !== e.inArray(b, y) && d.push('active'),
            (b < r || b > a) && d.push('disabled'),
            b === v && d.push('focused'),
            l !== e.noop &&
              ((c = l(new Date(b, 0, 1))) === t
                ? (c = {})
                : 'boolean' == typeof c
                ? (c = { enabled: c })
      ...
      fill: function () {
        ...
        if (!isNaN(a) && !isNaN(l)) {
          this.picker
            ...
            .text(g.formatDate(r, v, this.o.language)),
            this.picker
              .find('tfoot .today')
              .text(f)
          ...
          var C = new Date(_);
          _.getUTCFullYear() < 100 && C.setUTCFullYear(_.getUTCFullYear()),
            C.setUTCDate(C.getUTCDate() + 42),
            (C = C.valueOf());
          for (var x, T, k = []; _.valueOf() < C; ) {
            if (
              (x = _.getUTCDay()) === this.o.weekStart &&
              (k.push('<tr>'), this.o.calendarWeeks)
            ) {
              var E = new Date(+_ + ((this.o.weekStart - x - 7) % 7) * 864e5),
                D = new Date(Number(E) + ((11 - E.getUTCDay()) % 7) * 864e5),
                A = new Date(
                  Number((A = n(D.getUTCFullYear(), 0, 1))) +
                    ((11 - A.getUTCDay()) % 7) * 864e5
                ),
                S = (D - A) / 864e5 / 7 + 1;
              k.push('<td class="cw">' + S + '</td>');
            }
            (T = this.getClassNames(_)).push('day');
            var $ = _.getUTCDate();
            this.o.beforeShowDay !== e.noop &&
              ...
              !1 === o.enabled && T.push('disabled'),
              o.classes && (T = T.concat(o.classes.split(/\s+/))),
              o.tooltip && (s = o.tooltip),
              o.content && ($ = o.content)),
              (T = e.isFunction(e.uniqueSort) ? e.uniqueSort(T) : e.unique(T)),
              k.push(
                '<td class="' +
                  T.join(' ') +
                  '"' +
          ...
          if (
            (e.each(this.dates, function (e, t) {
              t.getUTCFullYear() === a &&
                j.eq(t.getUTCMonth()).addClass('active');
            }),
            (a < d || a > c) && j.addClass('disabled'),
            a === d && j.slice(0, u).addClass('disabled'),
            a === c && j.slice(h + 1).addClass('disabled'),
            this.o.beforeShowMonth !== e.noop)
          ) {
            var M = this;
            e.each(j, function (n, i) {
              var s = new Date(a, n, 1),
        ...
        if (this._allow_update) {
          ...
          switch (this.viewMode) {
            ...
            case 2:
              d *= 10;
            case 1:
              (e = Math.floor(i / d) * d <= o),
                (t = Math.floor(i / d) * d + d > a);
              break;
            case 0:
              (e = i <= o && s <= r), (t = i >= a && s >= l);
          }
      ...
      click: function (t) {
        ...
        t.preventDefault(),
          t.stopPropagation(),
          (s = e(t.target)).hasClass('datepicker-switch') &&
          ...
          switch (e.keyCode) {
            ...
            case 40:
              ...
              (t = 37 === e.keyCode || 38 === e.keyCode ? -1 : 1),
                0 === this.viewMode
                  ? e.ctrlKey
                    ? (n = this.moveAvailableDate(s, t, 'moveYear')) &&
                      this._trigger('changeYear', this.viewDate)
                    : e.shiftKey
                    ? (n = this.moveAvailableDate(s, t, 'moveMonth')) &&
                      this._trigger('changeMonth', this.viewDate)
                    : 37 === e.keyCode || 39 === e.keyCode
                    ? (n = this.moveAvailableDate(s, t, 'moveDay'))
                    : this.weekOfDateIsDisabled(s) ||
                      (n = this.moveAvailableDate(s, t, 'moveWeek'))
                  : 1 === this.viewMode
        ...
        if (!this.updating) {
          ...
          if (i !== t) {
            var s = i.getUTCDate(),
              ...
              r = e.inArray(n.target, this.inputs),
              a = r - 1,
              l = r + 1,
            ...
            if (-1 !== r) {
              if (
                (e.each(this.pickers, function (e, t) {
                  t.getUTCDate() || (t !== i && o) || t.setUTCDate(s);
                }),
                s < this.dates[a])
              )
    ...
    var c = e.fn.datepicker,
      h = function (n) {
        ...
        if (
          ...
          i === t || i instanceof d || i instanceof u)
        )
          return this;
        if (this.length > 1)
          throw new Error(
      ...
      g = {
        ...
        parseDate: function (n, s, o, r) {
          ...
          if (
            ...
            for (
              l = n.match(/([\-+]\d+)([dmwy])/gi), n = new Date(), h = 0;
              h < l.length;
              h++
            )
          ...
          (C.yy = C.yyyy), (C.M = C.MM = C.mm = C.m), (C.dd = C.d), (n = i());
          var x = s.parts.slice();
          if (
            (l.length !== x.length &&
              (x = e(x)
            ...
            var T, k, E;
            for (h = 0, T = x.length; h < T; h++) {
              if (((y = parseInt(l[h], 10)), (u = x[h]), isNaN(y)))
                switch (u) {
                  case 'MM':
                    (b = e(m[o].months).filter(a)),
                      (y = e.inArray(b[0], m[o].months) + 1);
                    break;
                  case 'M':
                    (b = e(m[o].monthsShort).filter(a)),
                      (y = e.inArray(b[0], m[o].monthsShort) + 1);
                }
              _[u] = y;
            }
            for (h = 0; h < w.length; h++)
              (E = w[h]) in _ &&
                !isNaN(_[E]) &&
                ((k = new Date(n)), C[E](k, _[E]), isNaN(k) || (n = k));
          }
          return n;
        },
        formatDate: function (t, n, i) {
          if (!t) return '';
          if (('string' == typeof n && (n = g.parseFormat(n)), n.toDisplay))
          ...
          (s.dd = (s.d < 10 ? '0' : '') + s.d),
            ...
            (t = []);
          for (
            var o = e.extend([], n.separators), r = 0, a = n.parts.length;
            r <= a;
            r++
          )
            o.length && t.push(o.shift()), t.push(s[n.parts[r]]);
          return t.join('');
        },
        headTemplate:
            ...
            1 == n.pauseonhover &&
              e(a)
                .on('mouseenter', function () {
                  e(this).css({ animationPlayState: 'paused' });
                })
                .on('mouseleave', function () {
                  e(this).css({ animationPlayState: 'running' });
                });
            var d = function () {
              !(function (t, n) {
                if (
                ...
                (function (t, n) {
                  ...
                  for (i = 1; i <= n; ) s.clone(!0).appendTo(e(t)), i++;
                })(a, n.clone),
                (function (t, n, i, r) {
                  var a = s(t, i);
                  ('up' != i && 'down' != i) ||
                    e(t)
                      ...
                      .css({ height: a + 'px' });
                  var l = o(a, i);
                  e(t).attr('data-style', 'infiniteslide' + n);
                  var d,
                    u,
                    c =
                  ...
                  if (
                    (e('<style />')
                      .attr('id', 'infiniteslide' + n + '_style')
                      .html(c)
                      .appendTo('head'),
                    'right' == i || 'down' == i)
                  )
                  ...
                  e(t).css({
                    animation:
                      ...
                      n +
                      ' ' +
                      ((d = a), (u = r), d / u + 's linear 0s infinite') +
                      h,
                  });
                })(a, l, n.direction, n.speed),
                n.responsive &&
                    ...
                    var t = (function (e, t) {
                      ...
                      r = e('#' + i + '_style')
                        ...
                        .replace(
                          ...
                          'to {transform:translate3d(' + t + ')'
                        );
                    e('#' + i + '_style').html(r);
                  });
            };
            window.loaded ? d() : e(window).on('load', d);
          });
        };
      });
  })(jQuery),
  (function (e) {
    var t = {
        ...
        checkboxAutoFit: !1,
        optionAttributes: [],
        replacePlaceholderText: !0,
        onLoad: function (e) {},
        onOptionClick: function (e, t) {},
        onControlOpen: function (e) {},
        onControlClose: function (e) {},
        onSelectAll: function (e, t) {},
        onPlaceholder: function (e, t, n) {},
      },
      n = 1,
      i = 1;
    function s(i, s) {
      if (
        ((this.element = i),
        (this.options = e.extend(!0, {}, t, s)),
        (this.updateSelectAll = !0),
        (this.updatePlaceholder = !0),
        (this.listNumber = n),
        (n += 1),
        !e(this.element).attr('multiple'))
      )
        throw new Error(
      ...
      'placeholder' in this.options &&
        ((this.options.texts.placeholder = this.options.placeholder),
        delete this.options.placeholder),
        'default' in this.options.searchOptions &&
          ((this.options.texts.search = this.options.searchOptions.default),
          delete this.options.searchOptions.default),
        this.load();
    }
    'function' != typeof Array.prototype.map &&
      (Array.prototype.map = function (t, n) {
        return void 0 === n && (n = this), e.isArray(n) ? e.map(n, t) : [];
      }),
      ...
      (s.prototype = {
        load: function () {
          var t = this;
          if (
            'SELECT' != t.element.nodeName ||
            e(t.element).hasClass('jqmsLoaded')
          )
            return !0;
          e(t.element)
            .addClass('jqmsLoaded ms-list-' + t.listNumber)
            .data('plugin_multiselect-instance', t),
            e(t.element).after(
              '<div id="ms-list-' +
                t.listNumber +
          ...
          var n = e(t.element)
              .siblings('#ms-list-' + t.listNumber + '.ms-options-wrap')
            ...
            s = i.find('> ul');
          if (
            (t.options.showCheckbox
              ? t.options.checkboxAutoFit && i.addClass('checkbox-autofit')
              : i.addClass('hide-checkbox'),
            e(t.element).prop('disabled') && n.prop('disabled', !0),
            t.options.maxPlaceholderWidth &&
              n.css('maxWidth', t.options.maxPlaceholderWidth),
            t.options.maxHeight)
          )
            var o = t.options.maxHeight;
          else
            o =
              e(window).height() - i.offset().top + e(window).scrollTop() - 20;
          if (
            ((o = o < t.options.minHeight ? t.options.minHeight : o),
            i.css({
              maxWidth: t.options.maxWidth,
              minHeight: t.options.minHeight,
              maxHeight: o,
            }),
            i.on('touchmove mousewheel DOMMouseScroll', function (t) {
              if (e(this).outerHeight() < e(this)[0].scrollHeight) {
                var n = t.originalEvent,
                  i = n.wheelDelta || -n.detail;
                e(this).outerHeight() + e(this)[0].scrollTop >
                  e(this)[0].scrollHeight &&
                  (t.preventDefault(), (this.scrollTop += i < 0 ? 1 : -1));
              }
            }),
            e(document)
              .off('click.ms-hideopts')
              .on('click.ms-hideopts', function (t) {
                e(t.target).closest('.ms-options-wrap').length ||
                  e('.ms-options-wrap.ms-active > .ms-options').each(
                    function () {
                      e(this)
                        .closest('.ms-options-wrap')
                        .removeClass('ms-active');
                      var t = e(this).closest('.ms-options-wrap').attr('id'),
                        n = e(this)
                          .parent()
                          .siblings('.' + t + '.jqmsLoaded')
                          .data('plugin_multiselect-instance');
                      'function' == typeof n.options.onControlClose &&
                        n.options.onControlClose(n.element);
                    }
                  );
              })
              .on('keydown', function (t) {
                27 == (t.keyCode || t.which) &&
                  e(this).trigger('click.ms-hideopts');
              }),
            n.on('keydown', function (e) {
              var t = e.keyCode || e.which;
              (13 != t && 32 != t) || n.trigger('mousedown');
            }),
            n
              .on('mousedown', function (n) {
                if (n.which && 1 != n.which) return !0;
                if (
                  (e('.ms-options-wrap.ms-active').each(function () {
                    if (
                      e(this).siblings(
                        '.' + e(this).attr('id') + '.jqmsLoaded'
                      )[0] !=
                      i
                        .parent()
                        .siblings('.ms-list-' + t.listNumber + '.jqmsLoaded')[0]
                    ) {
                      e(this).removeClass('ms-active');
                      var n = e(this)
                        .siblings('.' + e(this).attr('id') + '.jqmsLoaded')
                        .data('plugin_multiselect-instance');
                      'function' == typeof n.options.onControlClose &&
                        n.options.onControlClose(n.element);
                    }
                  }),
                  i.closest('.ms-options-wrap').toggleClass('ms-active'),
                  i.closest('.ms-options-wrap').hasClass('ms-active'))
                ) {
                  if (
                    ('function' == typeof t.options.onControlOpen &&
                      t.options.onControlOpen(t.element),
                    i.css('maxHeight', ''),
                    t.options.maxHeight)
                  )
                    var s = t.options.maxHeight;
                  else
                    s =
                      e(window).height() -
                      i.offset().top +
                      ...
                      20;
                  s &&
                    ((s = s < t.options.minHeight ? t.options.minHeight : s),
                    i.css('maxHeight', s));
                } else 'function' == typeof t.options.onControlClose && t.options.onControlClose(t.element);
              })
              .click(function (e) {
                e.preventDefault();
              }),
            t.options.texts.placeholder &&
              n.find('span').text(t.options.texts.placeholder),
            t.options.search)
          ) {
            s.before(
              '<div class="ms-search"><input type="text" value="" placeholder="' +
                t.options.texts.search +
                '" /></div>'
            ),
              s.after(
                '<div class="no-result-message">' +
                  t.options.texts.searchNoResult +
                  '</div>'
              );
            var r = i.find('.ms-search input');
            r.on('keyup', function () {
              if (e(this).data('lastsearch') == e(this).val()) return !0;
              e(this).data('searchTimeout') &&
                clearTimeout(e(this).data('searchTimeout'));
              var n = e(this);
              e(this).data(
                'searchTimeout',
                setTimeout(function () {
                  n.data('lastsearch', n.val()),
                    'function' == typeof t.options.searchOptions.onSearch &&
                      t.options.searchOptions.onSearch(t.element);
                  var i = e.trim(r.val().toLowerCase());
                  i
                    ? (s
                        .find(
                          'li[data-search-term*="' + i + '"]:not(.optgroup)'
                        )
                        .removeClass('ms-hidden'),
                      s
                        .find(
                          'li:not([data-search-term*="' + i + '"], .optgroup)'
                        )
                        .addClass('ms-hidden'))
                    : s.find('.ms-hidden').removeClass('ms-hidden'),
                    t.options.searchOptions.showOptGroups ||
                      s.find('.optgroup').each(function () {
                        e(this).find('li:not(.ms-hidden)').length
                          ? e(this).show()
                          : e(this).hide();
                      }),
                    t._updateSelectAllText();
                }, t.options.searchOptions.delay)
              );
            });
          }
          t.options.selectAll &&
            s.before(
              '<a href="#" class="ms-selectall global">' +
                t.options.texts.selectAll +
                '</a>'
            ),
            i.on('click', '.ms-selectall', function (n) {
              n.preventDefault(),
                (t.updateSelectAll = !1),
                (t.updatePlaceholder = !1);
              var o = i
                .parent()
                .siblings('.ms-list-' + t.listNumber + '.jqmsLoaded');
              if (e(this).hasClass('global'))
                s.find(
                  ...
                  : (s
                    ...
                    s
                      ...
                      .prop('checked', !1));
              else if (e(this).closest('li').hasClass('optgroup')) {
                var r = e(this).closest('li.optgroup');
                r.find(
              ...
              s.find('li.selected input[type="checkbox"]').each(function () {
                ...
                (t.updateSelectAll = !0),
                (t.updatePlaceholder = !0),
                'function' == typeof t.options.onSelectAll &&
                  t.options.onSelectAll(t.element, a.length),
                t._updateSelectAllText(),
          ...
          e(t.element)
              ...
              if ('OPTGROUP' == this.nodeName) {
                ...
                e(this)
                  ...
                  .each(function () {
                    for (
                      var i = {}, s = 0;
                      s < t.options.optionAttributes.length;
                      s++
                    ) {
                      var o = t.options.optionAttributes[s];
                      void 0 !== e(this).attr(o) && (i[o] = e(this).attr(o));
                    }
                    n.push({
                      name: e(this).text(),
                      value: e(this).val(),
                      checked: e(this).prop('selected'),
                      attributes: i,
                    });
                  }),
                  a.push({ label: e(this).attr('label'), options: n });
              } else {
            ...
            i.on('click', 'input[type="checkbox"]', function () {
              e(this).closest('li').toggleClass('selected'),
                i
                  .parent()
                  .siblings('.ms-list-' + t.listNumber + '.jqmsLoaded')
                  .find(
                    'option[value="' + t._escapeSelector(e(this).val()) + '"]'
                  )
                  .prop('selected', e(this).is(':checked'))
                  .closest('select')
                  .trigger('change'),
                'function' == typeof t.options.onOptionClick &&
                  t.options.onOptionClick(t.element, this),
                t._updateSelectAllText(),
                t._updatePlaceholderText();
            }),
            i
              .on('focusin', 'input[type="checkbox"]', function () {
                e(this).closest('label').addClass('focused');
              })
              .on('focusout', 'input[type="checkbox"]', function () {
                e(this).closest('label').removeClass('focused');
              }),
            'function' == typeof t.options.onLoad &&
              t.options.onLoad(t.element),
            e(t.element).hide();
        },
        loadOptions: function (t, n, i) {
          (n = 'boolean' != typeof n || n), (i = 'boolean' != typeof i || i);
          var s = e(this.element),
            ...
            r = s
              .siblings('#ms-list-' + this.listNumber + '.ms-options-wrap')
              .find('> .ms-options');
          n && (o.find('> li').remove(), i && s.find('> *').remove());
          var a = [];
          for (var l in t)
              ...
              if (d.hasOwnProperty('value')) {
                if (
                  (this.options.showCheckbox &&
                    this.options.checkboxAutoFit &&
                    u.addClass('ms-reflow'),
                  this._addOption(u, d),
                  i)
                ) {
                  var h = e('<option/>', { value: d.value, text: d.name });
                  d.hasOwnProperty('attributes') &&
                    Object.keys(d.attributes).length &&
                    h.attr(d.attributes),
                    d.checked && h.prop('selected', !0),
                    s.append(h);
                }
              } else {
                if (!d.hasOwnProperty('options')) continue;
                var f = e('<optgroup/>', { label: d.label });
                for (var p in (o
                  .find('> li.optgroup > span.label')
                  .each(function () {
                    e(this).text() == d.label &&
                      ((u = e(this).closest('.optgroup')), (c = !1));
                  }),
                i &&
                  (s.find('optgroup[label="' + d.label + '"]').length
                    ? (f = s.find('optgroup[label="' + d.label + '"]'))
                    : s.append(f)),
                c &&
                  (u.addClass('optgroup'),
                  u.append('<span class="label">' + d.label + '</span>'),
                  u.find('> .label').css({ clear: 'both' }),
                  this.options.selectGroup &&
                    u.append(
                      '<a href="#" class="ms-selectall">' +
                        this.options.texts.selectAll +
                        '</a>'
                    ),
                  u.append('<ul/>')),
                d.options))
                  if (d.options.hasOwnProperty(p)) {
                    var m = d.options[p],
                      g = e('<li/>');
                    if (
                      (this.options.showCheckbox &&
                        this.options.checkboxAutoFit &&
                        g.addClass('ms-reflow'),
                      m.hasOwnProperty('value') &&
                        (this._addOption(g, m), u.find('> ul').append(g), i))
                    ) {
                      h = e('<option/>', { value: m.value, text: m.name });
                      m.hasOwnProperty('attributes') &&
                        Object.keys(m.attributes).length &&
                        h.attr(m.attributes),
                        m.checked && h.prop('selected', !0),
                        f.append(h);
                    }
                  }
              }
          ...
          if (
            ...
            this.options.checkboxAutoFit &&
              this.options.showCheckbox &&
              !r.hasClass('hide-checkbox'))
          ) {
            var v = o.find('.ms-reflow:eq(0) input[type="checkbox"]');
            if (v.length) {
              var y = v.outerWidth();
              (y = y || 15),
                o
                  ...
                  .css(
                    'padding-left',
                    2 * parseInt(v.closest('label').css('padding-left')) + y
                  ),
                o.find('.ms-reflow').removeClass('ms-reflow');
            }
          }
        ...
        settings: function (t) {
          (this.options = e.extend(!0, {}, this.options, t)), this.reload();
        },
        unload: function () {
          e(this.element)
            .siblings('#ms-list-' + this.listNumber + '.ms-options-wrap')
            .remove(),
            e(this.element).show(function () {
              e(this).css('display', '').removeClass('jqmsLoaded');
            });
        },
        reload: function () {
          e(this.element)
            .siblings('#ms-list-' + this.listNumber + '.ms-options-wrap')
            .remove(),
            e(this.element).removeClass('jqmsLoaded'),
            this.load();
        },
        reset: function () {
          var t = [];
          e(this.element)
            .find('option')
            .each(function () {
              e(this).prop('defaultSelected') && t.push(e(this).val());
            }),
        ...
        disable: function (t) {
          (t = 'boolean' != typeof t || t),
            e(this.element).prop('disabled', t),
            e(this.element)
              .siblings('#ms-list-' + this.listNumber + '.ms-options-wrap')
              .find('button:first-child')
              .prop('disabled', t);
            ...
            if (t.options.selectAll || t.options.selectGroup) {
              ...
              n.find('.ms-selectall').each(function () {
                ...
                e(this).text(
                  n.length
                    ? t.options.texts.selectAll
                    : t.options.texts.unselectAll
                );
              });
              var i = n.find('> ul li:not(.optgroup,.ms-hidden)').length;
              n.find('.no-result-message').toggle(!i),
                n.find('.ms-selectall.global').toggle(!!i);
            }
          }
        },
          ...
          if (this.updatePlaceholder) {
            var t = e(this.element),
              ...
              o = t
                .siblings('#ms-list-' + this.listNumber + '.ms-options-wrap')
                .find('> .ms-options');
            t.find('option:selected:disabled').length &&
              ((n = []),
              ...
              if (
                ...
                (r.push(
                  e.trim(
                    t
                      .find(
                        'option[value="' + this._escapeSelector(n[a]) + '"]'
                      )
                      .text()
                  )
                ),
                r.length >= this.options.maxPlaceholderOpts)
              )
                break;
            s.text(r.join(', ')),
              r.length
                ? (o.closest('.ms-options-wrap').addClass('ms-has-selections'),
                  'function' == typeof this.options.onPlaceholder &&
                    this.options.onPlaceholder(this.element, s, r))
                : o
                    .closest('.ms-options-wrap')
                    .removeClass('ms-has-selections'),
              r.length
                ? this.options.replacePlaceholderText &&
                  (s.width() > i.width() || r.length != n.length) &&
                  s.text(n.length + this.options.texts.selectedOptions)
                : s.text(this.options.texts.placeholder);
          }
        },
        _addOption: function (t, n) {
          var s = e('<div/>').html(n.name).text(),
            o = e('<label/>', { for: 'ms-opt-' + i }).text(s),
            r = e('<input>', {
              type: 'checkbox',
              title: s,
              id: 'ms-opt-' + i,
          ...
          n.hasOwnProperty('attributes') &&
            Object.keys(n.attributes).length &&
            r.attr(n.attributes),
            n.checked &&
              (t.addClass('default selected'), r.prop('checked', !0)),
            o.prepend(r);
          var a = '';
          this.options.searchOptions.searchText && (a += ' ' + s.toLowerCase()),
            this.options.searchOptions.searchValue &&
              (a += ' ' + n.value.toLowerCase()),
            t.attr('data-search-term', e.trim(a)).prepend(o),
            (i += 1);
        },
        _ieVersion: function () {
      ...
      (e.fn.multiselect = function (t) {
        if (this.length) {
          ...
          return void 0 === t || 'object' == typeof t
            ? this.each(function () {
                e.data(this, 'plugin_multiselect') ||
                  e.data(this, 'plugin_multiselect', new s(this, t));
              })
            : 'string' == typeof t && '_' !== t[0] && 'init' !== t
            ? (this.each(function () {
                var o = e.data(this, 'plugin_multiselect');
                o instanceof s &&
                  'function' == typeof o[t] &&
                  (n = o[t].apply(o, Array.prototype.slice.call(i, 1))),
                  'unload' === t && e.data(this, 'plugin_multiselect', null);
              }),
              n)
            : void 0;
        }
    ...
    e.fn.visible = function (e, n, i) {
      if (!(this.length < 1)) {
        var s = this.length > 1 ? this.eq(0) : this,
          ...
          r = t.width(),
          a = t.height(),
          l = ((i = i || 'both'), !0 !== n || o.offsetWidth * o.offsetHeight);
        if ('function' == typeof o.getBoundingClientRect) {
          var d = o.getBoundingClientRect(),
            u = d.top >= 0 && d.top < a,
            c = d.bottom > 0 && d.bottom <= a,
            h = d.left >= 0 && d.left < r,
            f = d.right > 0 && d.right <= r,
            p = e ? u || c : u && c,
            m = e ? h || f : h && f;
          ...
          var g = t.scrollTop(),
            ...
            D = !0 === e ? T : x,
            A = !0 === e ? x : T;
          if ('both' === i) return !!l && v >= E && k >= g && b >= A && D >= y;
          if ('vertical' === i) return !!l && v >= E && k >= g;
          if ('horizontal' === i) return !!l && b >= A && D >= y;
        }
      }
    };
  })(jQuery),
  ...
  jQuery(document).ready(function () {
    jQuery('#searchPopupModal').on('shown.bs.modal', function () {
      ...
      jQuery('#pleaseShowUploadCVModal').length > 0 &&
        jQuery('#uploadCVModal').modal(
          { backdrop: 'static', keyboard: !1 },
          'show'
        ),
      jQuery('#pleaseAddCookiesScriptForPopups').length;
  }),
  jQuery(document).ready(function () {
    if (
      (mobileAndTabletCheck()
        ? ($('body').addClass('is-mobile'),
          $('.header__video')
            .find('video')
            .on('click', function () {
              $(this).get(0).paused || $(this).get(0).ended
                ? $(this).get(0).play()
                : $(this).get(0).pause();
            }))
      ...
      'job-alert' === getParameterByName('modal') &&
      ...
      $('.body-bg-gradient').length > 0 && bodyGradient(),
      $('div.dropdown-menu')
        .parent()
      ...
      0 != $('.home__middle-hashtags').length && homeHashtags(),
      $('#searchModal') &&
        $('#searchModal').on('shown.bs.modal', function (e) {
          $('#searchModal').find('.searchInput').find('input').focus();
        }),
      $('#job-application-form').length > 0 &&
        (afterFormOpen(),
  ...
  jQuery(window).on('load', function () {
    lazyImages(),
      megaMenu(),
      bottomBar(),
      $('.owl-carousel').length > 0 && runOwlCarousels(),
      $('.body-bg-gradient').length > 0 && bodyGradient();
  }),
  ...
  jQuery(document).on('click', '.dropdown-menu', function (e) {
    $(e.target).not('.mega-menu-go-back') && e.stopPropagation();
  });
