        ...
        <div class="modal-content">
            ...
            <div class="modal-container">
                ...
                <div class="modal-body pt-3">
                    <form class="pt-3" action="<?php echo home_url( '/' ); ?>" method="GET">
                        <div class="row">
                            ...
                            <div class="col-lg-9 searchInput">
                                ...
                                <input type="text" name="s" value="<?= get_search_query(); ?>" placeholder="<?php pll_e('Let me help you find the perfect job'); ?>">
