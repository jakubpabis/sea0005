                            ...
                            <form method="POST" action="<?php echo esc_url( admin_url('admin-post.php') ); ?>" accept-charset="UTF-8" role="form" id="<?php echo $type; ?>-popup-form" enctype="multipart/form-data">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-12 pt-1">
                                        ...
                                        <button type="button" class="fake_btn_cv btn btn__default yellow"><?= pll_e( 'Send message' ); ?></button>
                                        <button class="g-recaptcha btn btn__default yellow d-none" data-sitekey="6LeA-gUaAAAAAE0620g-jcBqsq67NPiBtcj0NrCf" data-callback="on<?php echo $type; ?>Submit"><?= pll_e( 'Send message' ); ?></button>
                                    </div>
                                </div>
                            </form>
                        </div>
                        ...
                        <form method="POST" action="<?php echo esc_url( admin_url('admin-post.php') ); ?>" accept-charset="UTF-8" role="form" id="<?php echo $type; ?>-popup-form" enctype="multipart/form-data">
                            <div class="row align-items-center">
                                ...
                                <div class="col-12 pt-1">
                                    ...
                                    <button class="g-recaptcha btn btn__default yellow d-none" data-sitekey="6LeA-gUaAAAAAE0620g-jcBqsq67NPiBtcj0NrCf" data-callback="on<?php echo $type; ?>Submit"><?= pll_e( 'Subscribe now' ); ?></button>
                                </div>
                            </div>
                        </form>
                    </div>
