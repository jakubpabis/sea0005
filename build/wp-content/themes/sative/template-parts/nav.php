...
<nav class="navigation">
	<div class="navigation__upper">
		<div class="container-xl">
			<div class="row justify-content-lg-between align-items-center d-none d-lg-flex">
				<div class="col-auto">
				...
				<div class="col-md-10 col-auto d-none d-lg-block">
					<div class="row justify-content-end align-items-center">
						...
						<div class="col-lg-auto py-2 pl-4">
							<a href="mailto:contact@searchxrecruitment.com"><i class="fas fa-envelope"></i>contact@searchxrecruitment.com</a>
						</div>
						<div class="col-lg-auto py-2 pl-4">
							<a href="tel:+31207782393"><i class="fas fa-phone-alt"></i>+31 (0)20 - 7782393</a>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="col">
					<div class="row align-items-center justify-content-end">
						...
						<div class="col-auto pl-1 navigation__lower-utils d-flex flex-row align-items-center">
							<a href="javascript:void(0)" class="d-none d-lg-inline-block" data-toggle="modal" data-target="#searchPopupModal"><i class="fas fa-search"></i></a>
							<a href="javascript:void(0)" class="btn btn__small navy d-none d-lg-inline-block" data-toggle="modal" data-target="#uploadCVModal">
								<?php pll_e('Upload CV'); ?>
							</a>
							<a href="mailto:contact@searchxrecruitment.com" class="navigation__lower-btn-other d-lg-none d-flex align-items-center justify-content-center"><i class="fas fa-envelope"></i></a>
							<a href="tel:+31207782393" class="navigation__lower-btn-other d-lg-none d-flex align-items-center justify-content-center"><i class="fas fa-phone-alt"></i></a>
