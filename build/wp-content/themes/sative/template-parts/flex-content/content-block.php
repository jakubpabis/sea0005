				...
				<div class="flex-content">
					...
					<div class="d-flex">
						<?php if(get_sub_field('button_1') && get_sub_field('button_1')['url']): ?>
							<a herf="<?php echo get_sub_field('button_1')['url']; ?>" target="<?php echo get_sub_field('button_1')['target']; ?>" class="btn btn__default mr-3 <?php echo get_sub_field('button_1_color'); ?>"><?php echo get_sub_field('button_1')['title']; ?></a>
						<?php endif; ?>
						<?php if(get_sub_field('button_2') && get_sub_field('button_2')['url']): ?>
							<a herf="<?php echo get_sub_field('button_2')['url']; ?>" target="<?php echo get_sub_field('button_2')['target']; ?>" class="btn btn__default <?php echo get_sub_field('button_2_color'); ?>"><?php echo get_sub_field('button_2')['title']; ?></a>
						<?php endif; ?>
					</div>
					<?php endif; ?>
				</div>
