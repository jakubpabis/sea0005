									...
									<div class="col-md-5">
										<?php if (has_post_thumbnail($item->ID)) : ?>
											<div class="team__item-img">
												<img class="lazy bg-cover h-100" data-src="<?php echo get_the_post_thumbnail_url($item->ID); ?>" alt="" loading="lazy">
											</div>
										<?php endif; ?>
									</div>
									<div class="col-md-7">
											...
											<div class="row justify-content-between">
												...
												<div class="col-lg-auto col-12 team__item-social d-flex flex-lg-column mt-lg-0 mt-3">
													...
													<?php if (get_field('linkedin', $item->ID)) : ?>
														<a href="<?php echo get_field('linkedin', $item->ID); ?>" class="btn btn__social notched navy mr-lg-0 mr-2"><i class="fab fa-linkedin-in"></i></a>
													<?php endif; ?>
												</div>
											</div>
