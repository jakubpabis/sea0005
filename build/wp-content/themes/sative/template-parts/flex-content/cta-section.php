		...
		<div class="row justify-content-end">
			...
			<div class="col-md-6 col-sm-9 offset-md-0 offset-sm-3 ordre-md-12 order-1 mb-md-0 mb-5" id="bottom-contact-dog-section">
				<?php if (get_sub_field('links') && !empty(get_sub_field('links'))) : ?>
					<div class="flex_content-contact-links d-flex justify-content-end">
					...
					<form method="POST" action="<?php echo esc_url(admin_url('admin-post.php')); ?>" accept-charset="UTF-8" role="form" id="<?php echo $type; ?>_section_form" enctype="multipart/form-data">
						<div class="owl-carousel owl-theme contact-form-carousel">
							...
							<div class="ugly p-2">
								...
								<button class="g-recaptcha contactF btn btn__default yellow" data-sitekey="6LdyeiQhAAAAAMsMwMmCkriZI74RsG7oPP5nqWoV" data-callback="onSmallContactSubmit"><?php echo pll_e('Send message'); ?></button>
							</div>
						</div>
					</form>
				<?php endif; ?>
