        ...
        <?php if( get_sub_field( 'image_position' ) === 'top' ): ?>
            ...
            <div class="row justify-content-between align-items-end">
                ...
                <div class="col-lg-2 text-right mb-n4">
                    <svg height="69" width="27" xmlns="http://www.w3.org/2000/svg"><path d="M15.567 0v62.181l9.094-9.192L27 55.353 13.5 69 0 55.353l2.339-2.364 9.92 10.027V0z" fill="#183153"/></svg>
                </div>
            </div>
