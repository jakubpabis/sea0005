...
<header class="header__generic">
    <div class="container">
        ...
        <?php endif; ?>
        <div class="row align-items-center justify-content-sm-between justify-content-end  header__jobs-search knowledge">
...
<main class="knowledge">
    <div class="container">
        <div class="row justify-content-md-center justify-content-end">
            ...
            <aside class="col-lg-4 col-md-12 col-11 order-lg-12 order-1 knowledge__filters not-opened">
                <div class="closethis">
