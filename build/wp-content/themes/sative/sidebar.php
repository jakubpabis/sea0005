<div class="card bg-sea">
	...
	<div class="btns mt-4">
		...
		<a class="mt-2 text-size-medium" href="mailto:contact@searchxrecruitment.com"><i class="far fa-envelope mr-2"></i>contact@searchxrecruitment.com</a><br />
...
<div class="share">
	...
	<div class="btns">
		...
		<a class="btn btn__social notched navy" href="whatsapp://send?text=<?php echo get_the_title(); ?>&nbsp;&nbsp;<?php echo $current_url; ?>" data-action="share/whatsapp/share" target="_blank">
