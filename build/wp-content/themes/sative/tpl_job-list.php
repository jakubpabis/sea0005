...
<header class="header__jobs">
    <div class="container">
        ...
        <form action="<?php echo home_url( '/' ); ?>" id="search-filter" method="GET" class="row align-items-center justify-content-md-between justify-content-end header__jobs-search">
