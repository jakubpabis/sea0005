                ...
                <div class="col-md-6 d-flex">
                    <div class="card w-100">
                        ...
                        <div class="btns mt-3">
                            ...
                            <a href="<?= get_sub_field('button')['url']; ?>" class="btn btn__default navy mr-4">
                                <?= get_sub_field('button')['title']; ?>
                            </a>
                            <?php endif; ?>
                            <?php if(get_sub_field('additional_link')): ?>
                            <a href="<?= get_sub_field('additional_link')['url']; ?>" class="link text-size-medium color-pink d-inline-block mt-4"><?= get_sub_field('additional_link')['title']; ?></a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
