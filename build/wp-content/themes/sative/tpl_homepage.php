			...
			<?php if (have_rows('middle_cards')) : ?>
				...
				<section class="home__cards cards__section">
					<div class="cards__section-img">
						<img src="<?php echo get_field('middle_cards_image')['url']; ?>" alt="<?php echo get_field('middle_cards_image')['alt']; ?>" class="bg-cover" loading="lazy">
					</div>
			...
			<?php if ($query->have_posts()) : ?>
				<section class="home__testimonials testimonials__section">
					<div class="testimonials__section-img">
						<img src="<?php echo get_field('testimonial_image')['url']; ?>" alt="" class="bg-cover" loading="lazy">
					</div>
																...
																<div class="row">
																	<?php if (has_post_thumbnail()) : ?>
																		<div class="col-lg-2 col-md-3">
																			<img src="<?php echo get_the_post_thumbnail_url(); ?>" alt="" class="bg-cover" loading="lazy">
																		</div>
							...
							<div class="col-lg-10 col-sm-9 col-10">
								<div class="owl-carousel owl-theme">
									<?php while (have_rows('clients')) : the_row(); ?>
										<img class="owl-lazy" src="<?php echo get_sub_field('image')['url']; ?>" alt="" loading="lazy">
									<?php endwhile; ?>
								</div>
