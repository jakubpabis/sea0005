...
<head>
    ...
    <link rel="stylesheet" href="<?= get_template_directory_uri(); ?>/assets/css/main.min.css?v=1.0.2">
                    ...
                    <ul class="lang d-lg-none d-flex">
                        <?php if( pll_current_language() === 'en' ): ?>
                            <li class="lang-item lang-item-en current-lang lang-item-first">
                                <a lang="en-GB" hreflang="en-GB" href="<?php echo $url_en; ?>">en</a>
                            </li>
                            <li class="lang-item lang-item-nl">
                                <a lang="nl-NL" hreflang="nl-NL" href="<?php echo $url_nl; ?>">nl</a>
                            </li>
                        <?php else: ?>
                            <li class="lang-item lang-item-en lang-item-first">
                                <a lang="en-GB" hreflang="en-GB" href="<?php echo $url_en; ?>">en</a>
                            </li>
                            <li class="lang-item lang-item-nl current-lang">
                                <a lang="nl-NL" hreflang="nl-NL" href="<?php echo $url_nl; ?>">nl</a>
                            </li>
                        <?php endif; ?>
                    </ul>
