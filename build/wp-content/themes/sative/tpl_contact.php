...
<?php if (has_post_thumbnail()) : ?>
	<header class="header__contact">
		<img class="bg-cover-abs" src="<?php echo get_the_post_thumbnail_url(); ?>" alt="" loading="lazy">
	</header>
<?php endif; ?>
...
<section class="contact">
	<?php if (have_rows('section')) : while (have_rows('section')) : the_row(); ?>
			<section class="dog section yellow <?php echo get_row_index() % 2 !== 0 ? 'left' : 'right' ?> abs">
								...
								<div class="dog__info left bg-yellow contact__text">
									...
									<?php if (get_sub_field('left_column_text')) : ?>
										<div class="row contact__text-columns">
											<div class="<?php echo get_sub_field('right_column_text') ? 'col-lg-6' : 'col-12' ?>">
												<?php echo get_sub_field('left_column_text'); ?>
											</div>
											<?php if (get_sub_field('right_column_text')) : ?>
												<div class="col-lg-6">
													<?php echo get_sub_field('right_column_text'); ?>
												</div>
											<?php endif; ?>
										</div>
									<?php endif; ?>
										...
										<div class="row contact__text-columns align-items-center">
											<div class="<?php echo get_sub_field('socials') ? 'col-lg-6' : 'col-12' ?>">
												...
												<?php if (get_sub_field('phone')) : ?>
													<br />
													<a class="d-inline-block mt-1 text-size-medium" href="tel:<?php echo get_sub_field('phone'); ?>"><i class="fas fa-mobile-android-alt mr-sm-4 mr-2"></i><?php echo get_sub_field('phone'); ?></a>
												<?php endif; ?>
											</div>
											<?php if (have_rows('socials')) : ?>
												<div class="col-lg-6">
													<?php while (have_rows('socials')) : the_row(); ?>
														<a href="<?php echo get_sub_field('url'); ?>" class="btn btn__social notched navy" target="_blank">
															<i class="<?php echo get_sub_field('icon_code'); ?>"></i>
														</a>
													<?php endwhile; ?>
												</div>
											<?php endif; ?>
